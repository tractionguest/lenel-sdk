...
instance = SwaggerClient::InstanceDefinition.new # InstanceDefinition | The new instance.
...
instance = SwaggerClient::InstanceDefinition.new # InstanceDefinition | The instance to delete, with only key properties required.
...
execute_method_parameters = SwaggerClient::ExecuteMethodParameters.new # ExecuteMethodParameters | The execute method parameters.
...
in_parameter_value_map = SwaggerClient::InParameterValueMap.new # InParameterValueMap | 
...
opts = { 
  modified_access_level: SwaggerClient::AccessLevel.new, # AccessLevel | The modified access level.
  queue: false # BOOLEAN | Queues the request as a task and returns a response identical to `GET /queue/{id}`.
}
...
instance = SwaggerClient::InstanceDefinition.new # InstanceDefinition | The updated instance.
...
parameter_name = SwaggerClient::ParameterName2.new # ParameterName2 | 
...
opts = { 
  print_request: SwaggerClient::PrintRequest.new, # PrintRequest | Additional parameters associated with a badge print request.
  queue: false # BOOLEAN | Queues the request as a task and returns a response identical to `GET /queue/{id}`.
}
