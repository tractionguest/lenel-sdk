...
modified_password_policy_settings = SwaggerClient::PasswordPolicySettings.new # PasswordPolicySettings | The modified password policy settings.
...
visit_settings = SwaggerClient::VisitSettings1.new # VisitSettings1 | 
