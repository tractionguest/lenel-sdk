...
module LenelClient
  ...
  class AuthorizationWarningOptionsFontProperties
    ...
    def self.swagger_types
      {
        ...
        :'out_precision' => :'String',
        :'clip_precision' => :'String',
        :'quality' => :'String',
        :'pitch' => :'String',
        :'family' => :'String',
        :'face_name' => :'String'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'character_set')
        self.character_set = attributes[:'character_set']
      end

      if attributes.has_key?(:'out_precision')
        self.out_precision = attributes[:'out_precision']
      end

      if attributes.has_key?(:'clip_precision')
      ...
      if attributes.has_key?(:'face_name')
