...
module LenelClient
  class DirectoryAccountsMatchingCardholdersSuccessfulListItemList
    ...
    def self.swagger_types
      {
        ...
        :'directory_account' => :'DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cardholder_id')
        self.cardholder_id = attributes[:'cardholder_id']
      end

      if attributes.has_key?(:'directory_account')
