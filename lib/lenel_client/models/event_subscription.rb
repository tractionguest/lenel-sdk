...
module LenelSDK
  class EventSubscription
    ...
    def self.swagger_types
      {
        ...
        :'message_broker_hostname' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'binding_key')
      ...
      if attributes.has_key?(:'exchange_name')
      ...
      if attributes.has_key?(:'is_durable')
        self.is_durable = attributes[:'is_durable']
      end

      if attributes.has_key?(:'last_updated_date')
        self.last_updated_date = attributes[:'last_updated_date']
      end

      if attributes.has_key?(:'message_broker_hostname')
        self.message_broker_hostname = attributes[:'message_broker_hostname']
      end

      if attributes.has_key?(:'message_broker_port')
      ...
      if attributes.has_key?(:'requires_secure_connection')
    ...
    def hash
      [version, binding_key, created_date, description, exchange_name, filter, id, is_durable, last_updated_date, message_broker_hostname, message_broker_port, queue_name, requires_secure_connection, user_id].hash
    end
