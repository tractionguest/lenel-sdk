...
module LenelSDK
  class ParameterName1
    ...
    def self.swagger_types
      {
        :'directory_account_property' => :'String',
        :'cardholder_property' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'directory_account_property')
        self.directory_account_property = attributes[:'directory_account_property']
      end

      if attributes.has_key?(:'cardholder_property')
        self.cardholder_property = attributes[:'cardholder_property']
      end

      if attributes.has_key?(:'can_overwrite')
