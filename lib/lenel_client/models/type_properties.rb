...
module LenelClient
  class TypeProperties
    ...
    def self.swagger_types
      {
        ...
        :'display_attributes' => :'Array<TypeDisplayAttributes>',
        :'display_name' => :'String',
        :'is_key' => :'BOOLEAN',
        :'is_required' => :'BOOLEAN',
        :'max_length' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'display_attributes')
      ...
      if attributes.has_key?(:'is_key')
        self.is_key = attributes[:'is_key']
      end

      if attributes.has_key?(:'is_required')
      ...
      if attributes.has_key?(:'possible_values')
