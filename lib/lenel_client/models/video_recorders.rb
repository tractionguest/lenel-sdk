...
module LenelSDK
  class VideoRecorders
    ...
    def self.swagger_types
      {
        ...
        :'primary_ip_address' => :'Integer',
        :'segment_id' => :'Integer',
        :'workstation' => :'String',
        :'world_timezone_id' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'http_port')
      ...
      if attributes.has_key?(:'is_daylight_saving')
      ...
      if attributes.has_key?(:'panel_type_id')
        self.panel_type_id = attributes[:'panel_type_id']
      end

      if attributes.has_key?(:'panel_type_name')
        self.panel_type_name = attributes[:'panel_type_name']
      end

      if attributes.has_key?(:'primary_ip_address')
      ...
      if attributes.has_key?(:'workstation')
        self.workstation = attributes[:'workstation']
      end

      if attributes.has_key?(:'world_timezone_id')
