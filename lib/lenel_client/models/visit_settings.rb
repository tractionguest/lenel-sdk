...
module LenelSDK
  class VisitSettings
    ...
    def self.swagger_types
      {
        ...
        :'default_visitor_badge_type_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'default_visitor_badge_type_id')
        self.default_visitor_badge_type_id = attributes[:'default_visitor_badge_type_id']
      end

      if attributes.has_key?(:'default_visitor_badge_type_name')
    ...
    def hash
      [version, default_visitor_badge_type_id, default_visitor_badge_type_name].hash
    end
