...
require 'lenel_sdk/models/add_device_group_request'
require 'lenel_sdk/models/add_modify_device_group_device_instance'
require 'lenel_sdk/models/add_modify_device_group_response'
require 'lenel_sdk/models/add_user_preferences'
require 'lenel_sdk/models/all_of_add_device_group_request_devices_items'
require 'lenel_sdk/models/all_of_console_card_group_cards_items'
require 'lenel_sdk/models/all_of_console_layout_groups_items'
require 'lenel_sdk/models/all_of_get_access_panels_with_certs_and_users_instance_access_panel_users_items'
require 'lenel_sdk/models/all_of_get_device_group_instance_devices_items'
require 'lenel_sdk/models/all_of_incoming_event_actions_items'
require 'lenel_sdk/models/all_of_map_icon_group_map_item_group_members_items'
require 'lenel_sdk/models/all_of_modify_device_group_request_devices_items'
require 'lenel_sdk/models/all_of_send_incoming_events_response_failure_list_item_list_items'
require 'lenel_sdk/models/authentication_body'
...
require 'lenel_sdk/models/badge_printers_body'
require 'lenel_sdk/models/badge_printers_body_1'
require 'lenel_sdk/models/badge_printers_body_2'
require 'lenel_sdk/models/badge_printers_printers'
require 'lenel_sdk/models/badgekey_issue_mobile_credential_body'
require 'lenel_sdk/models/badgekey_print_request_body'
...
require 'lenel_sdk/models/get_access_panel_user_instance'
require 'lenel_sdk/models/get_access_panels_with_certs_and_users_instance'
require 'lenel_sdk/models/get_access_panels_with_certs_and_users_response'
require 'lenel_sdk/models/get_console_cards'
require 'lenel_sdk/models/get_device_group_device_instance'
require 'lenel_sdk/models/get_device_group_instance'
require 'lenel_sdk/models/get_device_groups_response'
require 'lenel_sdk/models/get_logged_events'
require 'lenel_sdk/models/get_map_devices_response'
require 'lenel_sdk/models/get_map_icon_groups_response'
require 'lenel_sdk/models/get_map_icons_response'
require 'lenel_sdk/models/get_maps_response'
require 'lenel_sdk/models/get_user_preferences'
require 'lenel_sdk/models/get_video_recorders'
require 'lenel_sdk/models/get_visit_event_status'
require 'lenel_sdk/models/id_managed_access_levels_body'
require 'lenel_sdk/models/id_managed_access_levels_body_1'
require 'lenel_sdk/models/id_segments_body'
require 'lenel_sdk/models/id_segments_body_1'
require 'lenel_sdk/models/incoming_event'
require 'lenel_sdk/models/inline_response_200'
require 'lenel_sdk/models/inline_response_200_1'
require 'lenel_sdk/models/inline_response_200_2'
require 'lenel_sdk/models/inline_response_200_3'
require 'lenel_sdk/models/inline_response_200_4'
require 'lenel_sdk/models/inline_response_200_5'
require 'lenel_sdk/models/inline_response_200_6'
require 'lenel_sdk/models/inline_response_200_7'
require 'lenel_sdk/models/inline_response_200_8'
require 'lenel_sdk/models/inline_response_200_9'
...
require 'lenel_sdk/models/map_background'
require 'lenel_sdk/models/map_definition'
require 'lenel_sdk/models/map_device'
require 'lenel_sdk/models/map_icon'
require 'lenel_sdk/models/map_icon_group'
require 'lenel_sdk/models/map_item_group_member'
require 'lenel_sdk/models/modified_event_subscription'
require 'lenel_sdk/models/modify_device_group_request'
require 'lenel_sdk/models/modify_user_preferences'
require 'lenel_sdk/models/new_event_subscription'
require 'lenel_sdk/models/new_incoming_events'
...
require 'lenel_sdk/models/partner_values_body'
require 'lenel_sdk/models/partner_values_body_1'
require 'lenel_sdk/models/password_policy_settings'
require 'lenel_sdk/models/password_policy_settings_limits'
require 'lenel_sdk/models/property_bulk_update_body'
...
require 'lenel_sdk/models/segments_segment_list'
require 'lenel_sdk/models/send_incoming_events_response'
require 'lenel_sdk/models/send_incoming_events_response_failure_list'
require 'lenel_sdk/models/settings_visit_body'
...
require 'lenel_sdk/models/update_cardholder_with_directory_account_property_body'
require 'lenel_sdk/models/user_extended_properties'
require 'lenel_sdk/models/user_extended_properties_put'
require 'lenel_sdk/models/user_password_body'
require 'lenel_sdk/models/user_preference'
require 'lenel_sdk/models/user_preferences_body'
require 'lenel_sdk/models/user_preferences_body_1'
require 'lenel_sdk/models/video_options'
require 'lenel_sdk/models/video_recorder_authentication_data'
require 'lenel_sdk/models/video_recorder_credentials'
require 'lenel_sdk/models/video_recorders'
require 'lenel_sdk/models/visit_event_status'
...
require 'lenel_sdk/api/maps_api'
require 'lenel_sdk/api/printers_api'
...
loader.collapse("#{__dir__}/lenel_sdk/api",
                "#{__dir__}/lenel_sdk/models")
loader.setup
