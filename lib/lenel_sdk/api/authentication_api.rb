...
module LenelSdk
  class AuthenticationApi
    ...
    def add_authentication(body, version, opts = {})
      data, _status_code, _headers = add_authentication_with_http_info(body, version, opts)
      data
    end
    ...
    def add_authentication_with_http_info(body, version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthenticationApi.add_authentication ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AuthenticationApi.add_authentication"
      end
      ...
      auth_names = opts[:auth_names] || ['ApplicationId']
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [BOOLEAN] :queue Queues the request as a task and returns a response identical to &#x60;GET /queue/{id}&#x60;.
    # @return [Array<(Directories, Integer, Hash)>] Directories data, response status code and response headers
    def get_directories_with_http_info(version, opts = {})
      ...
      return_type = opts[:return_type] || 'Directories' 
