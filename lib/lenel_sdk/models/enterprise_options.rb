...
module LenelSDK
  class EnterpriseOptions
    ...
    def self.swagger_types
      {
        :'version' => :'String',
        :'default_user_replication' => :'Integer',
        :'default_cardholder_replication' => :'Integer',
        :'default_visitor_replication' => :'Integer',
        :'is_enterprise_system' => :'BOOLEAN',
        :'is_master_server' => :'BOOLEAN',
        :'local_database_id' => :'Integer',
        :'server_list' => :'Array<EnterpriseOptionsServerList>'
      }
    end
    ...
    def hash
      [version, default_user_replication, default_cardholder_replication, default_visitor_replication, is_enterprise_system, is_master_server, local_database_id, server_list].hash
    end
