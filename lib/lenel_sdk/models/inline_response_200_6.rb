...
module LenelSdk
  class InlineResponse2006
    ...
    # Indicates if the client should display the authorization warning.
    attr_accessor :display_authorization_warning

    attr_accessor :authorization_warning_options

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'version' => :'version',
        :'display_authorization_warning' => :'display_authorization_warning',
        :'authorization_warning_options' => :'authorization_warning_options'
      }
    end
    ...
    def self.openapi_types
      {
        :'version' => :'Object',
        :'display_authorization_warning' => :'Object',
        :'authorization_warning_options' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LenelSdk::InlineResponse2006` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LenelSdk::InlineResponse2006`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'display_authorization_warning')
        self.display_authorization_warning = attributes[:'display_authorization_warning']
      end

      if attributes.key?(:'authorization_warning_options')
        self.authorization_warning_options = attributes[:'authorization_warning_options']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          version == o.version &&
          display_authorization_warning == o.display_authorization_warning &&
          authorization_warning_options == o.authorization_warning_options
    end
    ...
    def hash
      [version, display_authorization_warning, authorization_warning_options].hash
    end
