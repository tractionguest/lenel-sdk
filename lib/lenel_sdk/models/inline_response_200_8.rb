...
module LenelSdk
  class InlineResponse2008
    ...
    attr_accessor :token_start_time
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `LenelSdk::InlineResponse2008` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `LenelSdk::InlineResponse2008`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'token_expiration_time')
        self.token_expiration_time = attributes[:'token_expiration_time']
      end

      if attributes.key?(:'token_start_time')
        self.token_start_time = attributes[:'token_start_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          token_expiration_time == o.token_expiration_time &&
          token_start_time == o.token_start_time &&
          user_id == o.user_id &&
          version == o.version
    end
    ...
    def hash
      [session_token, token_expiration_time, token_start_time, user_id, version].hash
    end
