...
module LenelSDK
  class UserExtendedProperties
    ...
    def self.swagger_types
      {
        :'version' => :'String',
        :'database_id' => :'Integer',
        :'has_aam_view_only_access' => :'BOOLEAN',
        :'monitoring_zone_id' => :'Integer',
        :'monitoring_zone_name' => :'String',
    ...
    def hash
      [version, database_id, has_aam_view_only_access, monitoring_zone_id, monitoring_zone_name, is_user_account_locked, last_successful_login_time].hash
    end
