...
module SwaggerClient
  class AllOfConsoleCardGroupCardsItems
    # The ID of the console card.
    attr_accessor :id

    # The group ID. 'hidden' if card is hidden.
    attr_accessor :group_id

    # The feature license id.
    attr_accessor :license

    # The console card displayed name.
    attr_accessor :display_name

    # The color in HEX.
    attr_accessor :color

    # The icon content in base64. Should start with 'data:*/*;base64,'.
    attr_accessor :icon
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AllOfConsoleCardGroupCardsItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AllOfConsoleCardGroupCardsItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'extended_properties')
        self.extended_properties = attributes[:'extended_properties']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          url == o.url &&
          type == o.type &&
          extended_properties == o.extended_properties && super(o)
    end
    ...
    def hash
      [id, group_id, license, display_name, color, icon, application_type, url, type, extended_properties].hash
    end
