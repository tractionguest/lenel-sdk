...
module SwaggerClient
  class AllOfGetDeviceGroupInstanceDevicesItems
    attr_accessor :panel_id

    attr_accessor :device_id

    attr_accessor :input_output_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AllOfGetDeviceGroupInstanceDevicesItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AllOfGetDeviceGroupInstanceDevicesItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'input_output_id')
        self.input_output_id = attributes[:'input_output_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          panel_type_name == o.panel_type_name && super(o)
    end
    ...
    def hash
      [panel_id, device_id, input_output_id, panel_type, device_name, panel_type_name].hash
    end
