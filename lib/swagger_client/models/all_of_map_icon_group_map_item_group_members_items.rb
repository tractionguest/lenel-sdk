...
module SwaggerClient
  class AllOfMapIconGroupMapItemGroupMembersItems
    attr_accessor :map_item_state
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AllOfMapIconGroupMapItemGroupMembersItems` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AllOfMapIconGroupMapItemGroupMembersItems`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'map_item_state')
        self.map_item_state = attributes[:'map_item_state']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          map_item_state == o.map_item_state &&
          icon_id == o.icon_id && super(o)
    end
