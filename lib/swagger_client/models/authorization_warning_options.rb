...
module SwaggerClient
  class AuthorizationWarningOptions
    # The authorization warning text to display. Can include HTML hyperlinks.
    attr_accessor :authorization_warning_text

    # The text to display on the Yes button.
    attr_accessor :yes_button_text

    # The text to display on the No button.
    attr_accessor :no_button_text

    # If true, the Yes button should be the default button in the authorization warning dialog.
    attr_accessor :yes_is_default_button

    attr_accessor :font_properties

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'authorization_warning_text' => :'authorization_warning_text',
        :'yes_button_text' => :'yes_button_text',
        :'no_button_text' => :'no_button_text',
        :'yes_is_default_button' => :'yes_is_default_button',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AuthorizationWarningOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AuthorizationWarningOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'authorization_warning_text')
        self.authorization_warning_text = attributes[:'authorization_warning_text']
      end

      if attributes.key?(:'yes_button_text')
        self.yes_button_text = attributes[:'yes_button_text']
      end

      if attributes.key?(:'no_button_text')
        self.no_button_text = attributes[:'no_button_text']
      end

      if attributes.key?(:'yes_is_default_button')
        self.yes_is_default_button = attributes[:'yes_is_default_button']
      end

      if attributes.key?(:'font_properties')
        self.font_properties = attributes[:'font_properties']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          authorization_warning_text == o.authorization_warning_text &&
          yes_button_text == o.yes_button_text &&
          no_button_text == o.no_button_text &&
          yes_is_default_button == o.yes_is_default_button &&
          font_properties == o.font_properties
    end
    ...
    def hash
      [authorization_warning_text, yes_button_text, no_button_text, yes_is_default_button, font_properties].hash
    end
