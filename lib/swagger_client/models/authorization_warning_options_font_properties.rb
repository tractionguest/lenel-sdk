...
module SwaggerClient
  ...
  class AuthorizationWarningOptionsFontProperties
    ...
    attr_accessor :out_precision

    attr_accessor :clip_precision
    ...
    def self.openapi_types
      {
        ...
        :'out_precision' => :'Object',
        :'clip_precision' => :'Object',
        :'quality' => :'Object',
        :'pitch' => :'Object',
        :'family' => :'Object',
        :'face_name' => :'Object'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AuthorizationWarningOptionsFontProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AuthorizationWarningOptionsFontProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'strikeout')
        self.strikeout = attributes[:'strikeout']
      end
      ...
      if attributes.key?(:'out_precision')
        self.out_precision = attributes[:'out_precision']
      end

      if attributes.key?(:'clip_precision')
        self.clip_precision = attributes[:'clip_precision']
      end
      ...
      if attributes.key?(:'face_name')
        self.face_name = attributes[:'face_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          out_precision == o.out_precision &&
          clip_precision == o.clip_precision &&
          quality == o.quality &&
          pitch == o.pitch &&
          family == o.family &&
    ...
    def hash
      [height, width, escapement, orientation, weight, italic, underline, strikeout, character_set, out_precision, clip_precision, quality, pitch, family, face_name].hash
    end
