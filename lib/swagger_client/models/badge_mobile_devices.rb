...
module SwaggerClient
  class BadgeMobileDevices
    attr_accessor :total_items

    attr_accessor :mobile_device_list
    ...
    def self.attribute_map
      {
        ...
        :'mobile_device_list' => :'mobile_device_list',
        :'version' => :'version'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BadgeMobileDevices` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BadgeMobileDevices`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mobile_device_list')
        if (value = attributes[:'mobile_device_list']).is_a?(Array)
          self.mobile_device_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mobile_device_list == o.mobile_device_list &&
    ...
    def hash
      [total_items, mobile_device_list, version].hash
    end
