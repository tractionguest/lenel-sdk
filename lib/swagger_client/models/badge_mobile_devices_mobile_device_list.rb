...
module SwaggerClient
  class BadgeMobileDevicesMobileDeviceList
    attr_accessor :mobile_device_id

    attr_accessor :mobile_device_description

    attr_accessor :mobile_device_active

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'mobile_device_id' => :'mobile_device_id',
        :'mobile_device_description' => :'mobile_device_description',
        :'mobile_device_active' => :'mobile_device_active'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'mobile_device_description' => :'Object',
        :'mobile_device_active' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BadgeMobileDevicesMobileDeviceList` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BadgeMobileDevicesMobileDeviceList`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mobile_device_description')
        self.mobile_device_description = attributes[:'mobile_device_description']
      end

      if attributes.key?(:'mobile_device_active')
        self.mobile_device_active = attributes[:'mobile_device_active']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mobile_device_description == o.mobile_device_description &&
          mobile_device_active == o.mobile_device_active
    end
    ...
    def hash
      [mobile_device_id, mobile_device_description, mobile_device_active].hash
    end
