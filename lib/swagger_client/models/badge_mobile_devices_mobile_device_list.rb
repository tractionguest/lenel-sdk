...
module SwaggerClient
  class BadgeMobileDevicesMobileDeviceList
    ...
    def self.swagger_types
      {
        ...
        :'mobile_device_description' => :'String',
        :'mobile_device_active' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mobile_device_id')
        self.mobile_device_id = attributes[:'mobile_device_id']
      end

      if attributes.has_key?(:'mobile_device_description')
        self.mobile_device_description = attributes[:'mobile_device_description']
      end

      if attributes.has_key?(:'mobile_device_active')
