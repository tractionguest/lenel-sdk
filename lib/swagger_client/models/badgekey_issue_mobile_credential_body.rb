...
module SwaggerClient
  class BadgekeyIssueMobileCredentialBody
    attr_accessor :mobile_device_id

    attr_accessor :send_email

    attr_accessor :mobile_issuance_method
    ...
    def self.attribute_map
      {
        ...
        :'mobile_issuance_method' => :'mobile_issuance_method'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::BadgekeyIssueMobileCredentialBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::BadgekeyIssueMobileCredentialBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mobile_issuance_method')
        self.mobile_issuance_method = attributes[:'mobile_issuance_method']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mobile_issuance_method == o.mobile_issuance_method
    end
    ...
    def hash
      [mobile_device_id, send_email, mobile_issuance_method].hash
    end
