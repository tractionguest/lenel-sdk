...
module SwaggerClient
  class CardholderOptionsBadgePinProperties
    attr_accessor :digits

    attr_accessor :generate_pin_code

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'digits' => :'digits',
        :'generate_pin_code' => :'generate_pin_code'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CardholderOptionsBadgePinProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CardholderOptionsBadgePinProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generate_pin_code')
        self.generate_pin_code = attributes[:'generate_pin_code']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          digits == o.digits &&
          generate_pin_code == o.generate_pin_code
    end
