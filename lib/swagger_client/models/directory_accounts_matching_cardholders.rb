...
module SwaggerClient
  class DirectoryAccountsMatchingCardholders
    ...
    def self.swagger_types
      {
        :'version' => :'String',
        :'successful_list' => :'DirectoryAccountsMatchingCardholdersSuccessfulList',
        :'failure_list' => :'DirectoryAccountsMatchingCardholdersFailureList'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'successful_list')
        self.successful_list = attributes[:'successful_list']
      end

      if attributes.has_key?(:'failure_list')
    ...
    def hash
      [version, successful_list, failure_list].hash
    end
