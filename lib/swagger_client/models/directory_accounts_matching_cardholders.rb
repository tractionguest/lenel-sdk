...
module SwaggerClient
  class DirectoryAccountsMatchingCardholders
    attr_accessor :successful_list

    attr_accessor :failure_list
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DirectoryAccountsMatchingCardholders` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DirectoryAccountsMatchingCardholders`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'successful_list')
        self.successful_list = attributes[:'successful_list']
      end

      if attributes.key?(:'failure_list')
        self.failure_list = attributes[:'failure_list']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          successful_list == o.successful_list &&
          failure_list == o.failure_list &&
    ...
    def hash
      [successful_list, failure_list, version].hash
    end
