...
module SwaggerClient
  class EnterpriseOptions
    attr_accessor :default_user_replication

    attr_accessor :default_cardholder_replication

    attr_accessor :default_visitor_replication

    attr_accessor :is_enterprise_system

    attr_accessor :is_master_server

    attr_accessor :local_database_id
    ...
    def self.attribute_map
      {
        :'default_user_replication' => :'default_user_replication',
        :'default_cardholder_replication' => :'default_cardholder_replication',
        :'default_visitor_replication' => :'default_visitor_replication',
        :'is_enterprise_system' => :'is_enterprise_system',
        :'is_master_server' => :'is_master_server',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EnterpriseOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EnterpriseOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_user_replication')
        self.default_user_replication = attributes[:'default_user_replication']
      end

      if attributes.key?(:'default_cardholder_replication')
        self.default_cardholder_replication = attributes[:'default_cardholder_replication']
      end

      if attributes.key?(:'default_visitor_replication')
        self.default_visitor_replication = attributes[:'default_visitor_replication']
      end

      if attributes.key?(:'is_enterprise_system')
        self.is_enterprise_system = attributes[:'is_enterprise_system']
      end

      if attributes.key?(:'is_master_server')
        self.is_master_server = attributes[:'is_master_server']
      end

      if attributes.key?(:'local_database_id')
        self.local_database_id = attributes[:'local_database_id']
      end

      if attributes.key?(:'server_list')
        if (value = attributes[:'server_list']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          default_user_replication == o.default_user_replication &&
          default_cardholder_replication == o.default_cardholder_replication &&
          default_visitor_replication == o.default_visitor_replication &&
          is_enterprise_system == o.is_enterprise_system &&
          is_master_server == o.is_master_server &&
          local_database_id == o.local_database_id &&
          server_list == o.server_list &&
    ...
    def hash
      [default_user_replication, default_cardholder_replication, default_visitor_replication, is_enterprise_system, is_master_server, local_database_id, server_list, version].hash
    end
