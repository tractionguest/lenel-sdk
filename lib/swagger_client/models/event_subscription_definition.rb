...
module SwaggerClient
  class EventSubscriptionDefinition
    ...
    def hash
      [binding_key, created_date, description, exchange_name, filter, id, is_durable, last_updated_date, message_broker_hostname, message_broker_port, queue_name, requires_secure_connection, user_id].hash
    end
