...
module SwaggerClient
  class EventSubscriptionDefinition
    ...
    attr_accessor :monitoring_zone_id
    ...
    attr_accessor :message_broker_hostname

    attr_accessor :message_broker_port
    ...
    def self.attribute_map
      {
        ...
        :'requires_secure_connection' => :'requires_secure_connection',
        :'user_id' => :'user_id'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'filter' => :'Object',
        :'monitoring_zone_id' => :'Object',
        :'id' => :'Object',
        :'is_durable' => :'Object',
        :'last_updated_date' => :'Object',
        :'message_broker_hostname' => :'Object',
        :'message_broker_port' => :'Object',
        :'queue_name' => :'Object',
        :'requires_secure_connection' => :'Object',
        :'user_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EventSubscriptionDefinition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EventSubscriptionDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'binding_key')
        self.binding_key = attributes[:'binding_key']
      end
      ...
      if attributes.key?(:'monitoring_zone_id')
        self.monitoring_zone_id = attributes[:'monitoring_zone_id']
      end
      ...
      if attributes.key?(:'message_broker_hostname')
        self.message_broker_hostname = attributes[:'message_broker_hostname']
      end

      if attributes.key?(:'message_broker_port')
        self.message_broker_port = attributes[:'message_broker_port']
      end
      ...
      if attributes.key?(:'requires_secure_connection')
        self.requires_secure_connection = attributes[:'requires_secure_connection']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          binding_key == o.binding_key &&
          created_date == o.created_date &&
          description == o.description &&
          type == o.type &&
          exchange_name == o.exchange_name &&
          filter == o.filter &&
          monitoring_zone_id == o.monitoring_zone_id &&
          id == o.id &&
          is_durable == o.is_durable &&
          last_updated_date == o.last_updated_date &&
          message_broker_hostname == o.message_broker_hostname &&
          message_broker_port == o.message_broker_port &&
          queue_name == o.queue_name &&
          requires_secure_connection == o.requires_secure_connection &&
          user_id == o.user_id
    end
    ...
    def hash
      [binding_key, created_date, description, type, exchange_name, filter, monitoring_zone_id, id, is_durable, last_updated_date, message_broker_hostname, message_broker_port, queue_name, requires_secure_connection, user_id].hash
    end
