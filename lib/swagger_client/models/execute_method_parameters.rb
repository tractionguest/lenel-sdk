...
module SwaggerClient
  class ExecuteMethodParameters
    attr_accessor :property_value_map

    attr_accessor :in_parameter_value_map

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'property_value_map' => :'property_value_map',
        :'in_parameter_value_map' => :'in_parameter_value_map'
      }
    end
    ...
    def self.openapi_types
      {
        :'property_value_map' => :'Object',
        :'in_parameter_value_map' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ExecuteMethodParameters` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ExecuteMethodParameters`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'property_value_map')
        self.property_value_map = attributes[:'property_value_map']
      end

      if attributes.key?(:'in_parameter_value_map')
        self.in_parameter_value_map = attributes[:'in_parameter_value_map']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          property_value_map == o.property_value_map &&
          in_parameter_value_map == o.in_parameter_value_map
    end
    ...
    def hash
      [property_value_map, in_parameter_value_map].hash
    end
