...
module SwaggerClient
  class ExecuteMethodResults
    attr_accessor :out_parameter_value_map
    ...
    def self.attribute_map
      {
        :'out_parameter_value_map' => :'out_parameter_value_map',
        :'version' => :'version'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ExecuteMethodResults` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ExecuteMethodResults`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'out_parameter_value_map')
        self.out_parameter_value_map = attributes[:'out_parameter_value_map']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          out_parameter_value_map == o.out_parameter_value_map &&
    ...
    def hash
      [out_parameter_value_map, version].hash
    end
