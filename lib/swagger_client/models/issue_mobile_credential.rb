...
module SwaggerClient
  class IssueMobileCredential
    ...
    def self.swagger_types
      {
        :'version' => :'String',
        :'mobile_device_activation_code' => :'Integer',
        :'mobile_device_pin' => :'String',
        :'mobile_device_for_installer' => :'BOOLEAN',
        :'mobile_issuance_message' => :'String'
      }
    end
    ...
    def hash
      [version, mobile_device_activation_code, mobile_device_pin, mobile_device_for_installer, mobile_issuance_message].hash
    end
