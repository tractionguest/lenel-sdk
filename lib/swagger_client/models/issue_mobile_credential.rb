...
module SwaggerClient
  class IssueMobileCredential
    attr_accessor :mobile_device_activation_code

    attr_accessor :mobile_device_pin

    attr_accessor :mobile_device_for_installer

    attr_accessor :mobile_issuance_message
    ...
    def self.attribute_map
      {
        :'mobile_device_activation_code' => :'mobile_device_activation_code',
        :'mobile_device_pin' => :'mobile_device_pin',
        :'mobile_device_for_installer' => :'mobile_device_for_installer',
        :'mobile_issuance_message' => :'mobile_issuance_message',
        :'version' => :'version'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::IssueMobileCredential` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::IssueMobileCredential`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mobile_device_activation_code')
        self.mobile_device_activation_code = attributes[:'mobile_device_activation_code']
      end

      if attributes.key?(:'mobile_device_pin')
        self.mobile_device_pin = attributes[:'mobile_device_pin']
      end

      if attributes.key?(:'mobile_device_for_installer')
        self.mobile_device_for_installer = attributes[:'mobile_device_for_installer']
      end

      if attributes.key?(:'mobile_issuance_message')
        self.mobile_issuance_message = attributes[:'mobile_issuance_message']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          mobile_device_activation_code == o.mobile_device_activation_code &&
          mobile_device_pin == o.mobile_device_pin &&
          mobile_device_for_installer == o.mobile_device_for_installer &&
          mobile_issuance_message == o.mobile_issuance_message &&
    ...
    def hash
      [mobile_device_activation_code, mobile_device_pin, mobile_device_for_installer, mobile_issuance_message, version].hash
    end
