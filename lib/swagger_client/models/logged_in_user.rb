...
module SwaggerClient
  class LoggedInUser
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'password_expiration_time')
        self.password_expiration_time = attributes[:'password_expiration_time']
      end

      if attributes.has_key?(:'ptz_priority')
    ...
    def hash
      [version, first_name, last_name, password_expiration_time, ptz_priority, user_id, user_name].hash
    end
