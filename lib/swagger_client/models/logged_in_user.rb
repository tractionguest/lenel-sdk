  ...
  class LoggedInUser
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::LoggedInUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::LoggedInUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'password_expiration_time')
        self.password_expiration_time = attributes[:'password_expiration_time']
      end

      if attributes.key?(:'ptz_priority')
        self.ptz_priority = attributes[:'ptz_priority']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_expiration_time == o.password_expiration_time &&
          ptz_priority == o.ptz_priority &&
          user_id == o.user_id &&
    ...
    def hash
      [first_name, last_name, password_expiration_time, ptz_priority, user_id, user_name, version].hash
    end
