...
module SwaggerClient
  class ManagedAccessLevels
    attr_accessor :has_aam_view_only_access

    attr_accessor :total_items

    attr_accessor :access_level_list
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ManagedAccessLevels` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ManagedAccessLevels`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'access_level_list')
        if (value = attributes[:'access_level_list']).is_a?(Array)
          self.access_level_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          access_level_list == o.access_level_list &&
    ...
    def hash
      [has_aam_view_only_access, total_items, access_level_list, version].hash
    end
