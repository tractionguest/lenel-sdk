...
module SwaggerClient
  class ManagedAccessLevels
    ...
    def self.swagger_types
      {
        ...
        :'total_items' => :'Integer',
        :'access_level_list' => :'Array<ManagedAccessLevelsAccessLevelList>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'access_level_list')
    ...
    def hash
      [version, has_aam_view_only_access, total_items, access_level_list].hash
    end
