...
module SwaggerClient
  class MapDevice
    attr_accessor :map_item_id

    attr_accessor :panel_id

    attr_accessor :device_id

    attr_accessor :input_device_id
    ...
    attr_accessor :map_item_type

    attr_accessor :icon_id

    attr_accessor :icon_group_id
    ...
    def self.openapi_types
      {
        ...
        :'panel_id' => :'Object',
        :'device_id' => :'Object',
        :'input_device_id' => :'Object',
        :'pos_x' => :'Object',
        :'pos_y' => :'Object',
        :'pos_z' => :'Object',
        :'map_item_type' => :'Object',
        :'icon_id' => :'Object',
        :'icon_group_id' => :'Object',
        :'custom_text' => :'Object',
        :'label_color' => :'Object',
        :'font_size' => :'Object',
        :'font_weight' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::MapDevice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::MapDevice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'map_item_id')
        self.map_item_id = attributes[:'map_item_id']
      end

      if attributes.key?(:'panel_id')
        self.panel_id = attributes[:'panel_id']
      end
      ...
      if attributes.key?(:'input_device_id')
        self.input_device_id = attributes[:'input_device_id']
      end

      if attributes.key?(:'pos_x')
        self.pos_x = attributes[:'pos_x']
      end

      if attributes.key?(:'pos_y')
        self.pos_y = attributes[:'pos_y']
      end

      if attributes.key?(:'pos_z')
        self.pos_z = attributes[:'pos_z']
      end

      if attributes.key?(:'map_item_type')
        self.map_item_type = attributes[:'map_item_type']
      end
      ...
      if attributes.key?(:'icon_group_id')
        self.icon_group_id = attributes[:'icon_group_id']
      end
      ...
      if attributes.key?(:'is_italic')
        self.is_italic = attributes[:'is_italic']
      end

      if attributes.key?(:'is_strikeout')
        self.is_strikeout = attributes[:'is_strikeout']
      end

      if attributes.key?(:'is_underline')
        self.is_underline = attributes[:'is_underline']
      end
      ...
      if attributes.key?(:'label_width')
        self.label_width = attributes[:'label_width']
      end

      if attributes.key?(:'label_height')
        self.label_height = attributes[:'label_height']
      end

      if attributes.key?(:'label_alignment')
        self.label_alignment = attributes[:'label_alignment']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          map_item_id == o.map_item_id &&
          panel_id == o.panel_id &&
          device_id == o.device_id &&
          input_device_id == o.input_device_id &&
          pos_x == o.pos_x &&
          pos_y == o.pos_y &&
          pos_z == o.pos_z &&
          map_item_type == o.map_item_type &&
          icon_id == o.icon_id &&
          icon_group_id == o.icon_group_id &&
          ...
          is_underline == o.is_underline &&
          label_text == o.label_text &&
          label_width == o.label_width &&
          label_height == o.label_height &&
          label_alignment == o.label_alignment
    end
    ...
    def hash
      [map_item_id, panel_id, device_id, input_device_id, pos_x, pos_y, pos_z, map_item_type, icon_id, icon_group_id, custom_text, label_color, font_size, font_weight, font_face, is_italic, is_strikeout, is_underline, label_text, label_width, label_height, label_alignment].hash
    end
