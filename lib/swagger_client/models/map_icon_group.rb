...
module SwaggerClient
  class MapIconGroup
    ...
    attr_accessor :map_item_group_members
    ...
    def self.attribute_map
      {
        ...
        :'map_item_group_members' => :'map_item_group_members'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::MapIconGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::MapIconGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'map_item_group_members')
        if (value = attributes[:'map_item_group_members']).is_a?(Array)
          self.map_item_group_members = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          map_item_group_members == o.map_item_group_members
    end
    ...
    def hash
      [icon_group_id, name, map_item_type, map_item_group_members].hash
    end
