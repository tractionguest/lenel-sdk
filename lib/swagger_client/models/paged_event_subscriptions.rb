...
module SwaggerClient
  class PagedEventSubscriptions
    ...
    def self.swagger_types
      {
        :'version' => :'String',
        :'count' => :'Integer',
        :'item_list' => :'Array<EventSubscriptionDefinition>',
        :'page_number' => :'Integer',
        :'page_size' => :'Integer',
        :'total_items' => :'Integer',
        :'total_pages' => :'Integer'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'item_list')
        if (value = attributes[:'item_list']).is_a?(Array)
          self.item_list = value
        end
      end

      if attributes.has_key?(:'page_number')
    ...
    def hash
      [version, count, item_list, page_number, page_size, total_items, total_pages].hash
    end
