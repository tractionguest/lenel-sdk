...
module SwaggerClient
  class PartnerValuesBody1
    attr_accessor :partner_value_1

    attr_accessor :partner_value_2

    attr_accessor :partner_value_3

    attr_accessor :partner_value_4

    attr_accessor :partner_value_5

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'partner_value_1' => :'partner_value_1',
        :'partner_value_2' => :'partner_value_2',
        :'partner_value_3' => :'partner_value_3',
        :'partner_value_4' => :'partner_value_4',
        :'partner_value_5' => :'partner_value_5'
      }
    end
    ...
    def self.openapi_types
      {
        :'partner_value_1' => :'Object',
        :'partner_value_2' => :'Object',
        :'partner_value_3' => :'Object',
        :'partner_value_4' => :'Object',
        :'partner_value_5' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PartnerValuesBody1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PartnerValuesBody1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'partner_value_1')
        self.partner_value_1 = attributes[:'partner_value_1']
      end

      if attributes.key?(:'partner_value_2')
        self.partner_value_2 = attributes[:'partner_value_2']
      end

      if attributes.key?(:'partner_value_3')
        self.partner_value_3 = attributes[:'partner_value_3']
      end

      if attributes.key?(:'partner_value_4')
        self.partner_value_4 = attributes[:'partner_value_4']
      end

      if attributes.key?(:'partner_value_5')
        self.partner_value_5 = attributes[:'partner_value_5']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          partner_value_1 == o.partner_value_1 &&
          partner_value_2 == o.partner_value_2 &&
          partner_value_3 == o.partner_value_3 &&
          partner_value_4 == o.partner_value_4 &&
          partner_value_5 == o.partner_value_5
    end
    ...
    def hash
      [partner_value_1, partner_value_2, partner_value_3, partner_value_4, partner_value_5].hash
    end
