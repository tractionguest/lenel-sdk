...
module SwaggerClient
  class PasswordPolicySettings
    ...
    def self.openapi_types
      {
        :'is_lockout_policy_enabled' => :'Object',
        :'login_attempt_threshold' => :'Object',
        :'login_attempt_reset_interval_in_minutes' => :'Object',
        :'lockout_interval_in_minutes' => :'Object',
        :'disable_lockout_for_sa' => :'Object',
        :'is_expiration_policy_enabled' => :'Object',
        :'expiration_days' => :'Object',
        :'is_expiration_reminders_enabled' => :'Object',
        :'expiration_first_reminder_days' => :'Object',
        :'expiration_reminder_days' => :'Object',
        :'is_minimum_length_required' => :'Object',
        :'minimum_length' => :'Object',
        :'is_numeric_characters_required' => :'Object',
        :'is_special_characters_required' => :'Object',
        :'is_upper_and_lower_case_required' => :'Object',
        :'can_be_same_as_user_name' => :'Object',
        :'is_history_policy_enabled' => :'Object',
        :'history_password_count' => :'Object',
        :'minimum_password_age' => :'Object',
        :'is_prohibited_password_policy_enabled' => :'Object',
        :'is_inactivity_timeout_policy_enabled' => :'Object',
        :'inactivity_timeout_in_minutes' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PasswordPolicySettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PasswordPolicySettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'is_lockout_policy_enabled')
        self.is_lockout_policy_enabled = attributes[:'is_lockout_policy_enabled']
      end

      if attributes.key?(:'login_attempt_threshold')
        self.login_attempt_threshold = attributes[:'login_attempt_threshold']
      end

      if attributes.key?(:'login_attempt_reset_interval_in_minutes')
        self.login_attempt_reset_interval_in_minutes = attributes[:'login_attempt_reset_interval_in_minutes']
      end

      if attributes.key?(:'lockout_interval_in_minutes')
        self.lockout_interval_in_minutes = attributes[:'lockout_interval_in_minutes']
      end

      if attributes.key?(:'disable_lockout_for_sa')
        self.disable_lockout_for_sa = attributes[:'disable_lockout_for_sa']
      end

      if attributes.key?(:'is_expiration_policy_enabled')
