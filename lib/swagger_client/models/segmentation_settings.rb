...
module SwaggerClient
  class SegmentationSettings
    attr_accessor :allow_access_levels_to_be_configured_as_assignable_by_other_segments

    attr_accessor :allow_segment_to_belong_to_multiple_groups

    attr_accessor :segment_badge_types

    attr_accessor :segment_card_formats

    attr_accessor :segment_cardholders

    attr_accessor :segment_non_system_list_builder_lists

    attr_accessor :segment_visitors

    attr_accessor :segmentation_enabled

    attr_accessor :extended_options
    ...
    def self.attribute_map
      {
        :'allow_access_levels_to_be_configured_as_assignable_by_other_segments' => :'allow_access_levels_to_be_configured_as_assignable_by_other_segments',
        :'allow_segment_to_belong_to_multiple_groups' => :'allow_segment_to_belong_to_multiple_groups',
        :'segment_badge_types' => :'segment_badge_types',
        :'segment_card_formats' => :'segment_card_formats',
        :'segment_cardholders' => :'segment_cardholders',
        :'segment_non_system_list_builder_lists' => :'segment_non_system_list_builder_lists',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::SegmentationSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::SegmentationSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allow_access_levels_to_be_configured_as_assignable_by_other_segments')
        self.allow_access_levels_to_be_configured_as_assignable_by_other_segments = attributes[:'allow_access_levels_to_be_configured_as_assignable_by_other_segments']
      end

      if attributes.key?(:'allow_segment_to_belong_to_multiple_groups')
        self.allow_segment_to_belong_to_multiple_groups = attributes[:'allow_segment_to_belong_to_multiple_groups']
      end

      if attributes.key?(:'segment_badge_types')
        self.segment_badge_types = attributes[:'segment_badge_types']
      end

      if attributes.key?(:'segment_card_formats')
        self.segment_card_formats = attributes[:'segment_card_formats']
      end

      if attributes.key?(:'segment_cardholders')
        self.segment_cardholders = attributes[:'segment_cardholders']
      end

      if attributes.key?(:'segment_non_system_list_builder_lists')
        self.segment_non_system_list_builder_lists = attributes[:'segment_non_system_list_builder_lists']
      end

      if attributes.key?(:'segment_visitors')
        self.segment_visitors = attributes[:'segment_visitors']
      end

      if attributes.key?(:'segmentation_enabled')
        self.segmentation_enabled = attributes[:'segmentation_enabled']
      end

      if attributes.key?(:'extended_options')
        self.extended_options = attributes[:'extended_options']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_access_levels_to_be_configured_as_assignable_by_other_segments == o.allow_access_levels_to_be_configured_as_assignable_by_other_segments &&
          allow_segment_to_belong_to_multiple_groups == o.allow_segment_to_belong_to_multiple_groups &&
          segment_badge_types == o.segment_badge_types &&
          segment_card_formats == o.segment_card_formats &&
          segment_cardholders == o.segment_cardholders &&
          segment_non_system_list_builder_lists == o.segment_non_system_list_builder_lists &&
          segment_visitors == o.segment_visitors &&
          segmentation_enabled == o.segmentation_enabled &&
          extended_options == o.extended_options &&
    ...
    def hash
      [allow_access_levels_to_be_configured_as_assignable_by_other_segments, allow_segment_to_belong_to_multiple_groups, segment_badge_types, segment_card_formats, segment_cardholders, segment_non_system_list_builder_lists, segment_visitors, segmentation_enabled, extended_options, version].hash
    end
