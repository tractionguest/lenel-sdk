...
module SwaggerClient
  class Type
    ...
    def self.swagger_types
      {
        ...
        :'access' => :'String',
        :'type_name' => :'String',
        :'display_groups' => :'Array<TypeDisplayGroups>',
        :'display_name' => :'String',
        :'methods' => :'Array<TypeMethods>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'display_groups')
    ...
    def hash
      [version, access, type_name, display_groups, display_name, methods, properties].hash
    end
