...
module SwaggerClient
  class TypeMethods
    ...
    attr_accessor :in_parameters

    attr_accessor :out_parameters
    ...
    def self.openapi_types
      {
        :'name' => :'Object',
        :'in_parameters' => :'Object',
        :'out_parameters' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::TypeMethods` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::TypeMethods`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'in_parameters')
        if (value = attributes[:'in_parameters']).is_a?(Array)
          self.in_parameters = value
        end
      end

      if attributes.key?(:'out_parameters')
        if (value = attributes[:'out_parameters']).is_a?(Array)
          self.out_parameters = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          in_parameters == o.in_parameters &&
          out_parameters == o.out_parameters
    end
    ...
    def hash
      [name, in_parameters, out_parameters].hash
    end
