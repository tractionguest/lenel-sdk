...
module SwaggerClient
  class UpdateCardholderWithDirectoryAccountPropertyBody
    attr_accessor :directory_account_property

    attr_accessor :cardholder_property
    ...
    def self.attribute_map
      {
        :'directory_account_property' => :'directory_account_property',
        :'cardholder_property' => :'cardholder_property',
    ...
    def self.openapi_types
      {
        :'directory_account_property' => :'Object',
        :'cardholder_property' => :'Object',
        :'can_overwrite' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UpdateCardholderWithDirectoryAccountPropertyBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UpdateCardholderWithDirectoryAccountPropertyBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'directory_account_property')
        self.directory_account_property = attributes[:'directory_account_property']
      end

      if attributes.key?(:'cardholder_property')
        self.cardholder_property = attributes[:'cardholder_property']
      end

      if attributes.key?(:'can_overwrite')
        self.can_overwrite = attributes[:'can_overwrite']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          directory_account_property == o.directory_account_property &&
          cardholder_property == o.cardholder_property &&
          can_overwrite == o.can_overwrite
    end
    ...
    def hash
      [directory_account_property, cardholder_property, can_overwrite].hash
    end
