...
module SwaggerClient
  class UserExtendedProperties
    attr_accessor :database_id

    attr_accessor :has_aam_view_only_access

    attr_accessor :monitoring_zone_id

    attr_accessor :monitoring_zone_name

    attr_accessor :is_user_account_locked
    ...
    def self.attribute_map
      {
        ...
        :'has_aam_view_only_access' => :'has_aam_view_only_access',
        :'monitoring_zone_id' => :'monitoring_zone_id',
        :'monitoring_zone_name' => :'monitoring_zone_name',
        :'is_user_account_locked' => :'is_user_account_locked',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UserExtendedProperties` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UserExtendedProperties`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_aam_view_only_access')
        self.has_aam_view_only_access = attributes[:'has_aam_view_only_access']
      end
      ...
      if attributes.key?(:'monitoring_zone_name')
        self.monitoring_zone_name = attributes[:'monitoring_zone_name']
      end

      if attributes.key?(:'is_user_account_locked')
        self.is_user_account_locked = attributes[:'is_user_account_locked']
      end

      if attributes.key?(:'last_successful_login_time')
        self.last_successful_login_time = attributes[:'last_successful_login_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_aam_view_only_access == o.has_aam_view_only_access &&
          monitoring_zone_id == o.monitoring_zone_id &&
          monitoring_zone_name == o.monitoring_zone_name &&
          is_user_account_locked == o.is_user_account_locked &&
          last_successful_login_time == o.last_successful_login_time &&
    ...
    def hash
      [database_id, has_aam_view_only_access, monitoring_zone_id, monitoring_zone_name, is_user_account_locked, last_successful_login_time, version].hash
    end
