...
module SwaggerClient
  class UserExtendedPropertiesPut
    ...
    # ID of the Monitoring Zone to assign to the user. Use zero or empty to unassign.
    attr_accessor :monitoring_zone_id

    # A flag indicating whether the user has AAM view-only access.
    attr_accessor :has_aam_view_only_access

    # A flag indicating whether to unlock the account of the user whose account has been locked by too many incorrect password attempts.
    ...
    def self.openapi_types
      {
        ...
        :'has_aam_view_only_access' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UserExtendedPropertiesPut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UserExtendedPropertiesPut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unlock_account')
        self.unlock_account = attributes[:'unlock_account']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unlock_account == o.unlock_account
    end
    ...
    def hash
      [database_id, monitoring_zone_id, has_aam_view_only_access, unlock_account].hash
    end
