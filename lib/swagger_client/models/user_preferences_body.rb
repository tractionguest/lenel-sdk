...
module SwaggerClient
  class UserPreferencesBody
    attr_accessor :preference_id

    attr_accessor :preference_settings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UserPreferencesBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UserPreferencesBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'preference_id')
        self.preference_id = attributes[:'preference_id']
      end

      if attributes.key?(:'preference_settings')
        self.preference_settings = attributes[:'preference_settings']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @preference_id.nil?
        invalid_properties.push('invalid value for "preference_id", preference_id cannot be nil.')
      end

      if @preference_settings.nil?
        invalid_properties.push('invalid value for "preference_settings", preference_settings cannot be nil.')
      end
    ...
    def valid?
      return false if @preference_id.nil?
      return false if @preference_settings.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          preference_settings == o.preference_settings
    end
    ...
    def hash
      [preference_id, preference_settings].hash
    end
