...
module SwaggerClient
  class VideoOptions
    attr_accessor :instant_rewind_time_in_seconds

    attr_accessor :time_limited_playback_restriction_in_minutes
    ...
    def self.attribute_map
      {
        :'instant_rewind_time_in_seconds' => :'instant_rewind_time_in_seconds',
        :'time_limited_playback_restriction_in_minutes' => :'time_limited_playback_restriction_in_minutes',
        :'version' => :'version'
      }
    end
    ...
    def self.openapi_types
      {
        :'instant_rewind_time_in_seconds' => :'',
        :'time_limited_playback_restriction_in_minutes' => :'',
        :'version' => :''
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::VideoOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::VideoOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'instant_rewind_time_in_seconds')
        self.instant_rewind_time_in_seconds = attributes[:'instant_rewind_time_in_seconds']
      end

      if attributes.key?(:'time_limited_playback_restriction_in_minutes')
        self.time_limited_playback_restriction_in_minutes = attributes[:'time_limited_playback_restriction_in_minutes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          instant_rewind_time_in_seconds == o.instant_rewind_time_in_seconds &&
          time_limited_playback_restriction_in_minutes == o.time_limited_playback_restriction_in_minutes &&
    ...
    def hash
      [instant_rewind_time_in_seconds, time_limited_playback_restriction_in_minutes, version].hash
    end
