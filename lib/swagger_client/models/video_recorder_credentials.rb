...
module SwaggerClient
  class VideoRecorderCredentials
    attr_accessor :video_recorder_hashed_data

    attr_accessor :video_recorder_user_name
    ...
    def self.attribute_map
      {
        :'video_recorder_hashed_data' => :'video_recorder_hashed_data',
        :'video_recorder_user_name' => :'video_recorder_user_name',
        :'version' => :'version'
      }
    end
    ...
    def self.openapi_types
      {
        :'video_recorder_hashed_data' => :'',
        :'video_recorder_user_name' => :'',
        :'version' => :''
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::VideoRecorderCredentials` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::VideoRecorderCredentials`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'video_recorder_hashed_data')
        self.video_recorder_hashed_data = attributes[:'video_recorder_hashed_data']
      end

      if attributes.key?(:'video_recorder_user_name')
        self.video_recorder_user_name = attributes[:'video_recorder_user_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          video_recorder_hashed_data == o.video_recorder_hashed_data &&
          video_recorder_user_name == o.video_recorder_user_name &&
    ...
    def hash
      [video_recorder_hashed_data, video_recorder_user_name, version].hash
    end
