...
module SwaggerClient
  class VisitEventStatus
    ...
    attr_accessor :visits_scheduled

    attr_accessor :visits_late

    attr_accessor :visits_active

    attr_accessor :visits_overstayed

    attr_accessor :visits_finisched
    ...
    def self.attribute_map
      {
        ...
        :'visits_late' => :'visits_late',
        :'visits_active' => :'visits_active',
        :'visits_overstayed' => :'visits_overstayed',
        :'visits_finisched' => :'visits_finisched'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'Object',
        :'visits_count' => :'Object',
        :'visits_scheduled' => :'Object',
        :'visits_late' => :'Object',
        :'visits_active' => :'Object',
        :'visits_overstayed' => :'Object',
        :'visits_finisched' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::VisitEventStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::VisitEventStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'visits_count')
        self.visits_count = attributes[:'visits_count']
      end

      if attributes.key?(:'visits_scheduled')
        self.visits_scheduled = attributes[:'visits_scheduled']
      end

      if attributes.key?(:'visits_late')
        self.visits_late = attributes[:'visits_late']
      end

      if attributes.key?(:'visits_active')
        self.visits_active = attributes[:'visits_active']
      end

      if attributes.key?(:'visits_overstayed')
        self.visits_overstayed = attributes[:'visits_overstayed']
      end

      if attributes.key?(:'visits_finisched')
        self.visits_finisched = attributes[:'visits_finisched']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          status == o.status &&
          visits_count == o.visits_count &&
          visits_scheduled == o.visits_scheduled &&
          visits_late == o.visits_late &&
          visits_active == o.visits_active &&
          visits_overstayed == o.visits_overstayed &&
          visits_finisched == o.visits_finisched
    end
    ...
    def hash
      [id, status, visits_count, visits_scheduled, visits_late, visits_active, visits_overstayed, visits_finisched].hash
    end
