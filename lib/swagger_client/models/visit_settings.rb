  ...
  class VisitSettings
    ...
    def self.openapi_types
      {
        ...
        :'signout_badge_status' => :'',
        :'default_time_in' => :'',
        :'default_time_out' => :'',
        :'sign_in_now_by_default' => :'',
        :'allow_disposable_badge' => :'',
        :'allow_access_badge' => :'',
        :'allow_email' => :'',
        :'include_default_recipients' => :'',
        :'include_host_email' => :'',
        :'include_visitor_email' => :'',
        :'refresh_rate' => :'',
        :'update_badges' => :'',
        :'prompt_to_update' => :'',
        :'version' => :''
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::VisitSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::VisitSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
