...
# Unit tests for SwaggerClient::CardholdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardholdersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CardholdersApi.new
  end
  ...
  describe 'test an instance of CardholdersApi' do
    it 'should create an instance of CardholdersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CardholdersApi)
    end
  end

  # unit tests for get_active_directory_accounts
  ...
  describe 'get_active_directory_accounts test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_cardholder_from_directory
  ...
  describe 'get_cardholder_from_directory test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_directory_accounts_matching_cardholders
  ...
  describe 'get_directory_accounts_matching_cardholders test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_cardholder_with_directory_account_property
  ...
  describe 'update_cardholder_with_directory_account_property test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
