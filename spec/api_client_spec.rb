...
describe LenelClient::ApiClient do
  context 'initialization' do
    context 'URL stuff' do
      context 'host' do
        it 'removes http from host' do
          LenelClient.configure { |c| c.host = 'http://example.com' }
          expect(LenelClient::Configuration.default.host).to eq('example.com')
        end

        it 'removes https from host' do
          LenelClient.configure { |c| c.host = 'https://wookiee.com' }
          expect(LenelClient::ApiClient.default.config.host).to eq('wookiee.com')
        end

        it 'removes trailing path from host' do
          LenelClient.configure { |c| c.host = 'hobo.com/v4' }
          expect(LenelClient::Configuration.default.host).to eq('hobo.com')
        end
      end

      context 'base_path' do
        it "prepends a slash to base_path" do
          LenelClient.configure { |c| c.base_path = 'v4/dog' }
          expect(LenelClient::Configuration.default.base_path).to eq('/v4/dog')
        end
        ...
        it "ends up as a blank string if nil" do
          LenelClient.configure { |c| c.base_path = nil }
          expect(LenelClient::Configuration.default.base_path).to eq('')
        end
      end
    end
  end
  ...
  describe 'params_encoding in #build_request' do
    let(:config) { LenelClient::Configuration.new }
    let(:api_client) { LenelClient::ApiClient.new(config) }

    it 'defaults to nil' do
      expect(LenelClient::Configuration.default.params_encoding).to eq(nil)
  ...
  describe 'timeout in #build_request' do
    ...
    it 'defaults to 0' do
      expect(LenelClient::Configuration.default.timeout).to eq(0)
  ...
  describe '#deserialize' do
    it "handles Array<Integer>" do
      api_client = LenelClient::ApiClient.new
  ...
  describe "#object_to_hash" do
    it 'ignores nils and includes empty arrays' do
      ...
      # api_client = LenelClient::ApiClient.new
      # _model = LenelClient::ModelName.new
  ...
  describe '#build_collection_param' do
    let(:param) { ['aa', 'bb', 'cc'] }
    let(:api_client) { LenelClient::ApiClient.new }
