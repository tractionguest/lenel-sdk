...
# Unit tests for SwaggerClient::AccessLevelManagerIds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessLevelManagerIds' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessLevelManagerIds.new
  end
  ...
  describe 'test an instance of AccessLevelManagerIds' do
    it 'should create an instance of AccessLevelManagerIds' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessLevelManagerIds)
    end
  end
  ...
  describe 'test attribute "user_id_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
