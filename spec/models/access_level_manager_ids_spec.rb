...
# Unit tests for LenelClient::AccessLevelManagerIds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessLevelManagerIds' do
  before do
    # run before each test
    @instance = LenelClient::AccessLevelManagerIds.new
  end
  ...
  describe 'test an instance of AccessLevelManagerIds' do
    it 'should create an instance of AccessLevelManagerIds' do
      expect(@instance).to be_instance_of(LenelClient::AccessLevelManagerIds)
    end
  end
