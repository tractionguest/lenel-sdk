...
# Unit tests for SwaggerClient::AccessLevel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessLevel' do
  before do
    # run before each test
    @instance = SwaggerClient::AccessLevel.new
  end
  ...
  describe 'test an instance of AccessLevel' do
    it 'should create an instance of AccessLevel' do
      expect(@instance).to be_instance_of(SwaggerClient::AccessLevel)
    end
  end
  ...
  describe 'test attribute "readers"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
