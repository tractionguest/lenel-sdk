...
# Unit tests for SwaggerClient::AddConsoleLayout
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddConsoleLayout' do
  before do
    # run before each test
    @instance = SwaggerClient::AddConsoleLayout.new
  end
  ...
  describe 'test an instance of AddConsoleLayout' do
    it 'should create an instance of AddConsoleLayout' do
      expect(@instance).to be_instance_of(SwaggerClient::AddConsoleLayout)
    end
  end
