...
# Unit tests for SwaggerClient::AddDeviceGroupRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddDeviceGroupRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::AddDeviceGroupRequest.new
  end
  ...
  describe 'test an instance of AddDeviceGroupRequest' do
    it 'should create an instance of AddDeviceGroupRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::AddDeviceGroupRequest)
    end
  end
