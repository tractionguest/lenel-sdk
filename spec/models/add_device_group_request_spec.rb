...
# Unit tests for LenelSdk::AddDeviceGroupRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddDeviceGroupRequest' do
  before do
    # run before each test
    @instance = LenelSdk::AddDeviceGroupRequest.new
  end
  ...
  describe 'test an instance of AddDeviceGroupRequest' do
    it 'should create an instance of AddDeviceGroupRequest' do
      expect(@instance).to be_instance_of(LenelSdk::AddDeviceGroupRequest)
    end
  end
