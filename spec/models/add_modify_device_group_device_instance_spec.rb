...
# Unit tests for SwaggerClient::AddModifyDeviceGroupDeviceInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddModifyDeviceGroupDeviceInstance' do
  before do
    # run before each test
    @instance = SwaggerClient::AddModifyDeviceGroupDeviceInstance.new
  end
  ...
  describe 'test an instance of AddModifyDeviceGroupDeviceInstance' do
    it 'should create an instance of AddModifyDeviceGroupDeviceInstance' do
      expect(@instance).to be_instance_of(SwaggerClient::AddModifyDeviceGroupDeviceInstance)
    end
  end
