...
# Unit tests for LenelSdk::AddModifyDeviceGroupResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddModifyDeviceGroupResponse' do
  before do
    # run before each test
    @instance = LenelSdk::AddModifyDeviceGroupResponse.new
  end
  ...
  describe 'test an instance of AddModifyDeviceGroupResponse' do
    it 'should create an instance of AddModifyDeviceGroupResponse' do
      expect(@instance).to be_instance_of(LenelSdk::AddModifyDeviceGroupResponse)
    end
  end
