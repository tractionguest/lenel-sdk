...
# Unit tests for LenelClient::AddUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddUserPreferences' do
  before do
    # run before each test
    @instance = LenelClient::AddUserPreferences.new
  end
  ...
  describe 'test an instance of AddUserPreferences' do
    it 'should create an instance of AddUserPreferences' do
      expect(@instance).to be_instance_of(LenelClient::AddUserPreferences)
    end
  end
