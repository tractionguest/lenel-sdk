...
# Unit tests for SwaggerClient::AddUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AddUserPreferences' do
  before do
    # run before each test
    @instance = SwaggerClient::AddUserPreferences.new
  end
  ...
  describe 'test an instance of AddUserPreferences' do
    it 'should create an instance of AddUserPreferences' do
      expect(@instance).to be_instance_of(SwaggerClient::AddUserPreferences)
    end
  end
