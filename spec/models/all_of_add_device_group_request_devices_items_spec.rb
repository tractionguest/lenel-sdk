...
# Unit tests for SwaggerClient::AllOfAddDeviceGroupRequestDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfAddDeviceGroupRequestDevicesItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfAddDeviceGroupRequestDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfAddDeviceGroupRequestDevicesItems' do
    it 'should create an instance of AllOfAddDeviceGroupRequestDevicesItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfAddDeviceGroupRequestDevicesItems)
    end
  end
