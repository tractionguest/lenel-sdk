...
# Unit tests for LenelSdk::AllOfAddDeviceGroupRequestDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfAddDeviceGroupRequestDevicesItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfAddDeviceGroupRequestDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfAddDeviceGroupRequestDevicesItems' do
    it 'should create an instance of AllOfAddDeviceGroupRequestDevicesItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfAddDeviceGroupRequestDevicesItems)
    end
  end
