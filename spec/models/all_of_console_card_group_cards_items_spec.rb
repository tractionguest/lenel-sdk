...
# Unit tests for LenelSdk::AllOfConsoleCardGroupCardsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfConsoleCardGroupCardsItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfConsoleCardGroupCardsItems.new
  end
  ...
  describe 'test an instance of AllOfConsoleCardGroupCardsItems' do
    it 'should create an instance of AllOfConsoleCardGroupCardsItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfConsoleCardGroupCardsItems)
    end
  end
