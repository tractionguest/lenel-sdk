...
# Unit tests for SwaggerClient::AllOfConsoleCardGroupCardsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfConsoleCardGroupCardsItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfConsoleCardGroupCardsItems.new
  end
  ...
  describe 'test an instance of AllOfConsoleCardGroupCardsItems' do
    it 'should create an instance of AllOfConsoleCardGroupCardsItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfConsoleCardGroupCardsItems)
    end
  end
  ...
  describe 'test attribute "extended_properties"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
