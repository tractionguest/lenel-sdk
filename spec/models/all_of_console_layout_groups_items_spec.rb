...
# Unit tests for SwaggerClient::AllOfConsoleLayoutGroupsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfConsoleLayoutGroupsItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfConsoleLayoutGroupsItems.new
  end
  ...
  describe 'test an instance of AllOfConsoleLayoutGroupsItems' do
    it 'should create an instance of AllOfConsoleLayoutGroupsItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfConsoleLayoutGroupsItems)
    end
  end
