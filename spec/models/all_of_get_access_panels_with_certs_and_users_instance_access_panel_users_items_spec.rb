...
# Unit tests for LenelSdk::AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems.new
  end
  ...
  describe 'test an instance of AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems' do
    it 'should create an instance of AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfGetAccessPanelsWithCertsAndUsersInstanceAccessPanelUsersItems)
    end
  end
