...
# Unit tests for SwaggerClient::AllOfGetDeviceGroupInstanceDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfGetDeviceGroupInstanceDevicesItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfGetDeviceGroupInstanceDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfGetDeviceGroupInstanceDevicesItems' do
    it 'should create an instance of AllOfGetDeviceGroupInstanceDevicesItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfGetDeviceGroupInstanceDevicesItems)
    end
  end
  ...
  describe 'test attribute "input_output_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
