...
# Unit tests for LenelSdk::AllOfGetDeviceGroupInstanceDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfGetDeviceGroupInstanceDevicesItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfGetDeviceGroupInstanceDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfGetDeviceGroupInstanceDevicesItems' do
    it 'should create an instance of AllOfGetDeviceGroupInstanceDevicesItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfGetDeviceGroupInstanceDevicesItems)
    end
  end
