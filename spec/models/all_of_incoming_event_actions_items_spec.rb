...
# Unit tests for SwaggerClient::AllOfIncomingEventActionsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfIncomingEventActionsItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfIncomingEventActionsItems.new
  end
  ...
  describe 'test an instance of AllOfIncomingEventActionsItems' do
    it 'should create an instance of AllOfIncomingEventActionsItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfIncomingEventActionsItems)
    end
  end
