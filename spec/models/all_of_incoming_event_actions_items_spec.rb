...
# Unit tests for LenelSdk::AllOfIncomingEventActionsItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfIncomingEventActionsItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfIncomingEventActionsItems.new
  end
  ...
  describe 'test an instance of AllOfIncomingEventActionsItems' do
    it 'should create an instance of AllOfIncomingEventActionsItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfIncomingEventActionsItems)
    end
  end
