...
# Unit tests for SwaggerClient::AllOfMapIconGroupMapItemGroupMembersItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfMapIconGroupMapItemGroupMembersItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfMapIconGroupMapItemGroupMembersItems.new
  end
  ...
  describe 'test an instance of AllOfMapIconGroupMapItemGroupMembersItems' do
    it 'should create an instance of AllOfMapIconGroupMapItemGroupMembersItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfMapIconGroupMapItemGroupMembersItems)
    end
  end
  describe 'test attribute "map_item_state"' do
    it 'should work' do
