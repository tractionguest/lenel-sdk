...
# Unit tests for LenelSdk::AllOfMapIconGroupMapItemGroupMembersItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfMapIconGroupMapItemGroupMembersItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfMapIconGroupMapItemGroupMembersItems.new
  end
  ...
  describe 'test an instance of AllOfMapIconGroupMapItemGroupMembersItems' do
    it 'should create an instance of AllOfMapIconGroupMapItemGroupMembersItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfMapIconGroupMapItemGroupMembersItems)
    end
  end
