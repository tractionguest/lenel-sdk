...
# Unit tests for LenelSdk::AllOfModifyDeviceGroupRequestDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfModifyDeviceGroupRequestDevicesItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfModifyDeviceGroupRequestDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfModifyDeviceGroupRequestDevicesItems' do
    it 'should create an instance of AllOfModifyDeviceGroupRequestDevicesItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfModifyDeviceGroupRequestDevicesItems)
    end
  end
