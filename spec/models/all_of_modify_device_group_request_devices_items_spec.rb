...
# Unit tests for SwaggerClient::AllOfModifyDeviceGroupRequestDevicesItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfModifyDeviceGroupRequestDevicesItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfModifyDeviceGroupRequestDevicesItems.new
  end
  ...
  describe 'test an instance of AllOfModifyDeviceGroupRequestDevicesItems' do
    it 'should create an instance of AllOfModifyDeviceGroupRequestDevicesItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfModifyDeviceGroupRequestDevicesItems)
    end
  end
