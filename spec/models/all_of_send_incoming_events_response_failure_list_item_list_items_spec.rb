...
# Unit tests for LenelSdk::AllOfSendIncomingEventsResponseFailureListItemListItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfSendIncomingEventsResponseFailureListItemListItems' do
  before do
    # run before each test
    @instance = LenelSdk::AllOfSendIncomingEventsResponseFailureListItemListItems.new
  end
  ...
  describe 'test an instance of AllOfSendIncomingEventsResponseFailureListItemListItems' do
    it 'should create an instance of AllOfSendIncomingEventsResponseFailureListItemListItems' do
      expect(@instance).to be_instance_of(LenelSdk::AllOfSendIncomingEventsResponseFailureListItemListItems)
    end
  end
