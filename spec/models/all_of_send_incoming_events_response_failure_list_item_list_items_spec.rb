...
# Unit tests for SwaggerClient::AllOfSendIncomingEventsResponseFailureListItemListItems
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AllOfSendIncomingEventsResponseFailureListItemListItems' do
  before do
    # run before each test
    @instance = SwaggerClient::AllOfSendIncomingEventsResponseFailureListItemListItems.new
  end
  ...
  describe 'test an instance of AllOfSendIncomingEventsResponseFailureListItemListItems' do
    it 'should create an instance of AllOfSendIncomingEventsResponseFailureListItemListItems' do
      expect(@instance).to be_instance_of(SwaggerClient::AllOfSendIncomingEventsResponseFailureListItemListItems)
    end
  end
  ...
  describe 'test attribute "extended_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "custom_attribute"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
