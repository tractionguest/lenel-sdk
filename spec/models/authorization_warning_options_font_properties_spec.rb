...
# Unit tests for LenelClient::AuthorizationWarningOptionsFontProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationWarningOptionsFontProperties' do
  before do
    # run before each test
    @instance = LenelClient::AuthorizationWarningOptionsFontProperties.new
  end
  ...
  describe 'test an instance of AuthorizationWarningOptionsFontProperties' do
    it 'should create an instance of AuthorizationWarningOptionsFontProperties' do
      expect(@instance).to be_instance_of(LenelClient::AuthorizationWarningOptionsFontProperties)
    end
  end
