...
# Unit tests for SwaggerClient::AuthorizationWarningOptionsFontProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationWarningOptionsFontProperties' do
  before do
    # run before each test
    @instance = SwaggerClient::AuthorizationWarningOptionsFontProperties.new
  end
  ...
  describe 'test an instance of AuthorizationWarningOptionsFontProperties' do
    it 'should create an instance of AuthorizationWarningOptionsFontProperties' do
      expect(@instance).to be_instance_of(SwaggerClient::AuthorizationWarningOptionsFontProperties)
    end
  end
  ...
  describe 'test attribute "escapement"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "strikeout"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "out_precision"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "clip_precision"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "face_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
