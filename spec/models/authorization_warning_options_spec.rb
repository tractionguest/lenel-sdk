...
# Unit tests for SwaggerClient::AuthorizationWarningOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationWarningOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::AuthorizationWarningOptions.new
  end
  ...
  describe 'test an instance of AuthorizationWarningOptions' do
    it 'should create an instance of AuthorizationWarningOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::AuthorizationWarningOptions)
    end
  end
  describe 'test attribute "authorization_warning_text"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "yes_button_text"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "no_button_text"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "yes_is_default_button"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "font_properties"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
