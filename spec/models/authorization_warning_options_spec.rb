...
# Unit tests for LenelSDK::AuthorizationWarningOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthorizationWarningOptions' do
  before do
    # run before each test
    @instance = LenelSDK::AuthorizationWarningOptions.new
  end
  ...
  describe 'test an instance of AuthorizationWarningOptions' do
    it 'should create an instance of AuthorizationWarningOptions' do
      expect(@instance).to be_instance_of(LenelSDK::AuthorizationWarningOptions)
    end
  end
