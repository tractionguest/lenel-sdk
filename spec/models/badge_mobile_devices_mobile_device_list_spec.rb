...
# Unit tests for SwaggerClient::BadgeMobileDevicesMobileDeviceList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgeMobileDevicesMobileDeviceList' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgeMobileDevicesMobileDeviceList.new
  end
  ...
  describe 'test an instance of BadgeMobileDevicesMobileDeviceList' do
    it 'should create an instance of BadgeMobileDevicesMobileDeviceList' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgeMobileDevicesMobileDeviceList)
    end
  end
  ...
  describe 'test attribute "mobile_device_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mobile_device_active"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
