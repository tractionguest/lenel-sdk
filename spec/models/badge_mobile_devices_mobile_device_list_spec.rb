...
# Unit tests for LenelClient::BadgeMobileDevicesMobileDeviceList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgeMobileDevicesMobileDeviceList' do
  before do
    # run before each test
    @instance = LenelClient::BadgeMobileDevicesMobileDeviceList.new
  end
  ...
  describe 'test an instance of BadgeMobileDevicesMobileDeviceList' do
    it 'should create an instance of BadgeMobileDevicesMobileDeviceList' do
      expect(@instance).to be_instance_of(LenelClient::BadgeMobileDevicesMobileDeviceList)
    end
  end
