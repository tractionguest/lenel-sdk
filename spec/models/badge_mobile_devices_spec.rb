...
# Unit tests for SwaggerClient::BadgeMobileDevices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgeMobileDevices' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgeMobileDevices.new
  end
  ...
  describe 'test an instance of BadgeMobileDevices' do
    it 'should create an instance of BadgeMobileDevices' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgeMobileDevices)
    end
  end
  ...
  describe 'test attribute "mobile_device_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
