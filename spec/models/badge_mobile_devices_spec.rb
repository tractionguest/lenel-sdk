...
# Unit tests for LenelClient::BadgeMobileDevices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgeMobileDevices' do
  before do
    # run before each test
    @instance = LenelClient::BadgeMobileDevices.new
  end
  ...
  describe 'test an instance of BadgeMobileDevices' do
    it 'should create an instance of BadgeMobileDevices' do
      expect(@instance).to be_instance_of(LenelClient::BadgeMobileDevices)
    end
  end
