...
# Unit tests for LenelClient::BadgePrintRequestResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintRequestResponse' do
  before do
    # run before each test
    @instance = LenelClient::BadgePrintRequestResponse.new
  end
  ...
  describe 'test an instance of BadgePrintRequestResponse' do
    it 'should create an instance of BadgePrintRequestResponse' do
      expect(@instance).to be_instance_of(LenelClient::BadgePrintRequestResponse)
    end
  end
