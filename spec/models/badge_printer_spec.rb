...
# Unit tests for SwaggerClient::BadgePrinter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrinter' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrinter.new
  end
  ...
  describe 'test an instance of BadgePrinter' do
    it 'should create an instance of BadgePrinter' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrinter)
    end
  end
