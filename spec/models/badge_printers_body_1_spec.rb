...
# Unit tests for SwaggerClient::BadgePrintersBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintersBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrintersBody1.new
  end
  ...
  describe 'test an instance of BadgePrintersBody1' do
    it 'should create an instance of BadgePrintersBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrintersBody1)
    end
  end
