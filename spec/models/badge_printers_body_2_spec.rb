...
# Unit tests for SwaggerClient::BadgePrintersBody2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintersBody2' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrintersBody2.new
  end
  ...
  describe 'test an instance of BadgePrintersBody2' do
    it 'should create an instance of BadgePrintersBody2' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrintersBody2)
    end
  end
