...
# Unit tests for SwaggerClient::BadgePrintersBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintersBody' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrintersBody.new
  end
  ...
  describe 'test an instance of BadgePrintersBody' do
    it 'should create an instance of BadgePrintersBody' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrintersBody)
    end
  end
