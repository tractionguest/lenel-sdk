...
# Unit tests for SwaggerClient::BadgePrintersPrinters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintersPrinters' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrintersPrinters.new
  end
  ...
  describe 'test an instance of BadgePrintersPrinters' do
    it 'should create an instance of BadgePrintersPrinters' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrintersPrinters)
    end
  end
  describe 'test attribute "badge_type_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "printer_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
