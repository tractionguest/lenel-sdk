...
# Unit tests for LenelSdk::BadgePrintersPrinters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrintersPrinters' do
  before do
    # run before each test
    @instance = LenelSdk::BadgePrintersPrinters.new
  end
  ...
  describe 'test an instance of BadgePrintersPrinters' do
    it 'should create an instance of BadgePrintersPrinters' do
      expect(@instance).to be_instance_of(LenelSdk::BadgePrintersPrinters)
    end
  end
