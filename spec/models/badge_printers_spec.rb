...
# Unit tests for SwaggerClient::BadgePrinters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgePrinters' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgePrinters.new
  end
  ...
  describe 'test an instance of BadgePrinters' do
    it 'should create an instance of BadgePrinters' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgePrinters)
    end
  end
