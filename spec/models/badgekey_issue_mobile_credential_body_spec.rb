...
# Unit tests for LenelSdk::BadgekeyIssueMobileCredentialBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgekeyIssueMobileCredentialBody' do
  before do
    # run before each test
    @instance = LenelSdk::BadgekeyIssueMobileCredentialBody.new
  end
  ...
  describe 'test an instance of BadgekeyIssueMobileCredentialBody' do
    it 'should create an instance of BadgekeyIssueMobileCredentialBody' do
      expect(@instance).to be_instance_of(LenelSdk::BadgekeyIssueMobileCredentialBody)
    end
  end
