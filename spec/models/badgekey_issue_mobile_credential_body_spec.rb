...
# Unit tests for SwaggerClient::BadgekeyIssueMobileCredentialBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgekeyIssueMobileCredentialBody' do
  before do
    # run before each test
    @instance = SwaggerClient::BadgekeyIssueMobileCredentialBody.new
  end
  ...
  describe 'test an instance of BadgekeyIssueMobileCredentialBody' do
    it 'should create an instance of BadgekeyIssueMobileCredentialBody' do
      expect(@instance).to be_instance_of(SwaggerClient::BadgekeyIssueMobileCredentialBody)
    end
  end
  ...
  describe 'test attribute "mobile_issuance_method"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
