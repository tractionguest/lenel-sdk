...
# Unit tests for LenelSdk::BadgekeyPrintRequestBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BadgekeyPrintRequestBody' do
  before do
    # run before each test
    @instance = LenelSdk::BadgekeyPrintRequestBody.new
  end
  ...
  describe 'test an instance of BadgekeyPrintRequestBody' do
    it 'should create an instance of BadgekeyPrintRequestBody' do
      expect(@instance).to be_instance_of(LenelSdk::BadgekeyPrintRequestBody)
    end
  end
