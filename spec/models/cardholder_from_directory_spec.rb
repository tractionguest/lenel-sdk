...
# Unit tests for LenelSDK::CardholderFromDirectory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardholderFromDirectory' do
  before do
    # run before each test
    @instance = LenelSDK::CardholderFromDirectory.new
  end
  ...
  describe 'test an instance of CardholderFromDirectory' do
    it 'should create an instance of CardholderFromDirectory' do
      expect(@instance).to be_instance_of(LenelSDK::CardholderFromDirectory)
    end
  end
