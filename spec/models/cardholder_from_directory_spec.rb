...
# Unit tests for SwaggerClient::CardholderFromDirectory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardholderFromDirectory' do
  before do
    # run before each test
    @instance = SwaggerClient::CardholderFromDirectory.new
  end
  ...
  describe 'test an instance of CardholderFromDirectory' do
    it 'should create an instance of CardholderFromDirectory' do
      expect(@instance).to be_instance_of(SwaggerClient::CardholderFromDirectory)
    end
  end
