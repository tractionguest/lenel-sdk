...
# Unit tests for SwaggerClient::CardholderOptionsBadgePinProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardholderOptionsBadgePinProperties' do
  before do
    # run before each test
    @instance = SwaggerClient::CardholderOptionsBadgePinProperties.new
  end
  ...
  describe 'test an instance of CardholderOptionsBadgePinProperties' do
    it 'should create an instance of CardholderOptionsBadgePinProperties' do
      expect(@instance).to be_instance_of(SwaggerClient::CardholderOptionsBadgePinProperties)
    end
  end
  ...
  describe 'test attribute "generate_pin_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
