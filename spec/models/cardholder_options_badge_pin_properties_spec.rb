...
# Unit tests for LenelSDK::CardholderOptionsBadgePinProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardholderOptionsBadgePinProperties' do
  before do
    # run before each test
    @instance = LenelSDK::CardholderOptionsBadgePinProperties.new
  end
  ...
  describe 'test an instance of CardholderOptionsBadgePinProperties' do
    it 'should create an instance of CardholderOptionsBadgePinProperties' do
      expect(@instance).to be_instance_of(LenelSDK::CardholderOptionsBadgePinProperties)
    end
  end
