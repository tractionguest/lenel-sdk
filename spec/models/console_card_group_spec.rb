...
# Unit tests for SwaggerClient::ConsoleCardGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsoleCardGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::ConsoleCardGroup.new
  end
  ...
  describe 'test an instance of ConsoleCardGroup' do
    it 'should create an instance of ConsoleCardGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::ConsoleCardGroup)
    end
  end
