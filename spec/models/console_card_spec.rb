...
# Unit tests for SwaggerClient::ConsoleCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsoleCard' do
  before do
    # run before each test
    @instance = SwaggerClient::ConsoleCard.new
  end
  ...
  describe 'test an instance of ConsoleCard' do
    it 'should create an instance of ConsoleCard' do
      expect(@instance).to be_instance_of(SwaggerClient::ConsoleCard)
    end
  end
