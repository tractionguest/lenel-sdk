...
# Unit tests for SwaggerClient::ConsoleLayout
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsoleLayout' do
  before do
    # run before each test
    @instance = SwaggerClient::ConsoleLayout.new
  end
  ...
  describe 'test an instance of ConsoleLayout' do
    it 'should create an instance of ConsoleLayout' do
      expect(@instance).to be_instance_of(SwaggerClient::ConsoleLayout)
    end
  end
