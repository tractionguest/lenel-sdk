...
# Unit tests for SwaggerClient::DirectoriesItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoriesItemList' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoriesItemList.new
  end
  ...
  describe 'test an instance of DirectoriesItemList' do
    it 'should create an instance of DirectoriesItemList' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoriesItemList)
    end
  end
