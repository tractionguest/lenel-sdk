...
# Unit tests for LenelClient::DirectoriesItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoriesItemList' do
  before do
    # run before each test
    @instance = LenelClient::DirectoriesItemList.new
  end
  ...
  describe 'test an instance of DirectoriesItemList' do
    it 'should create an instance of DirectoriesItemList' do
      expect(@instance).to be_instance_of(LenelClient::DirectoriesItemList)
    end
  end
