...
# Unit tests for LenelSDK::DirectoriesPropertyValueMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoriesPropertyValueMap' do
  before do
    # run before each test
    @instance = LenelSDK::DirectoriesPropertyValueMap.new
  end
  ...
  describe 'test an instance of DirectoriesPropertyValueMap' do
    it 'should create an instance of DirectoriesPropertyValueMap' do
      expect(@instance).to be_instance_of(LenelSDK::DirectoriesPropertyValueMap)
    end
  end
