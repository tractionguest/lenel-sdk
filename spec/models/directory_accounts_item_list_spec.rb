...
# Unit tests for SwaggerClient::DirectoryAccountsItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsItemList' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccountsItemList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsItemList' do
    it 'should create an instance of DirectoryAccountsItemList' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccountsItemList)
    end
  end
