...
# Unit tests for LenelClient::DirectoryAccountsMatchingCardholdersFailureListItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersFailureListItemList' do
  before do
    # run before each test
    @instance = LenelClient::DirectoryAccountsMatchingCardholdersFailureListItemList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersFailureListItemList' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersFailureListItemList' do
      expect(@instance).to be_instance_of(LenelClient::DirectoryAccountsMatchingCardholdersFailureListItemList)
    end
  end
