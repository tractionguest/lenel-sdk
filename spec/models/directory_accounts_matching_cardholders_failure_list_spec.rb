...
# Unit tests for LenelSDK::DirectoryAccountsMatchingCardholdersFailureList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersFailureList' do
  before do
    # run before each test
    @instance = LenelSDK::DirectoryAccountsMatchingCardholdersFailureList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersFailureList' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersFailureList' do
      expect(@instance).to be_instance_of(LenelSDK::DirectoryAccountsMatchingCardholdersFailureList)
    end
  end
