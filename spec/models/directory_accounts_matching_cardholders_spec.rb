...
# Unit tests for SwaggerClient::DirectoryAccountsMatchingCardholders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholders' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccountsMatchingCardholders.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholders' do
    it 'should create an instance of DirectoryAccountsMatchingCardholders' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccountsMatchingCardholders)
    end
  end
  describe 'test attribute "successful_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "failure_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
