...
# Unit tests for LenelClient::DirectoryAccountsMatchingCardholders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholders' do
  before do
    # run before each test
    @instance = LenelClient::DirectoryAccountsMatchingCardholders.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholders' do
    it 'should create an instance of DirectoryAccountsMatchingCardholders' do
      expect(@instance).to be_instance_of(LenelClient::DirectoryAccountsMatchingCardholders)
    end
  end
