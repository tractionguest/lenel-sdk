...
# Unit tests for LenelSdk::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
  before do
    # run before each test
    @instance = LenelSdk::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
      expect(@instance).to be_instance_of(LenelSdk::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount)
    end
  end
