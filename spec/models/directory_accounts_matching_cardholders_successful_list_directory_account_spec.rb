...
# Unit tests for SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListDirectoryAccount)
    end
  end
