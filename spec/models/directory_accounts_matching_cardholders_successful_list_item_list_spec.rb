...
# Unit tests for SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList)
    end
  end
  describe 'test attribute "cardholder_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "directory_account"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
