...
# Unit tests for LenelClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
  before do
    # run before each test
    @instance = LenelClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersSuccessfulListItemList' do
      expect(@instance).to be_instance_of(LenelClient::DirectoryAccountsMatchingCardholdersSuccessfulListItemList)
    end
  end
