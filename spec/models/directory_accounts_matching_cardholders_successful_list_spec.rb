...
# Unit tests for SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccountsMatchingCardholdersSuccessfulList' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulList.new
  end
  ...
  describe 'test an instance of DirectoryAccountsMatchingCardholdersSuccessfulList' do
    it 'should create an instance of DirectoryAccountsMatchingCardholdersSuccessfulList' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccountsMatchingCardholdersSuccessfulList)
    end
  end
