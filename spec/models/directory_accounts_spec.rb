...
# Unit tests for SwaggerClient::DirectoryAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DirectoryAccounts' do
  before do
    # run before each test
    @instance = SwaggerClient::DirectoryAccounts.new
  end
  ...
  describe 'test an instance of DirectoryAccounts' do
    it 'should create an instance of DirectoryAccounts' do
      expect(@instance).to be_instance_of(SwaggerClient::DirectoryAccounts)
    end
  end
