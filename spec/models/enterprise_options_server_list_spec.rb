...
# Unit tests for SwaggerClient::EnterpriseOptionsServerList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EnterpriseOptionsServerList' do
  before do
    # run before each test
    @instance = SwaggerClient::EnterpriseOptionsServerList.new
  end
  ...
  describe 'test an instance of EnterpriseOptionsServerList' do
    it 'should create an instance of EnterpriseOptionsServerList' do
      expect(@instance).to be_instance_of(SwaggerClient::EnterpriseOptionsServerList)
    end
  end
