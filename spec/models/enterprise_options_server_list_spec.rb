...
# Unit tests for LenelSDK::EnterpriseOptionsServerList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EnterpriseOptionsServerList' do
  before do
    # run before each test
    @instance = LenelSDK::EnterpriseOptionsServerList.new
  end
  ...
  describe 'test an instance of EnterpriseOptionsServerList' do
    it 'should create an instance of EnterpriseOptionsServerList' do
      expect(@instance).to be_instance_of(LenelSDK::EnterpriseOptionsServerList)
    end
  end
