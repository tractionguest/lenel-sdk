...
# Unit tests for SwaggerClient::EventSubscriptionDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSubscriptionDefinition' do
  before do
    # run before each test
    @instance = SwaggerClient::EventSubscriptionDefinition.new
  end
  ...
  describe 'test an instance of EventSubscriptionDefinition' do
    it 'should create an instance of EventSubscriptionDefinition' do
      expect(@instance).to be_instance_of(SwaggerClient::EventSubscriptionDefinition)
    end
  end
  describe 'test attribute "binding_key"' do
    it 'should work' do
  ...
  describe 'test attribute "monitoring_zone_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "is_durable"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "message_broker_hostname"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "message_broker_port"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "requires_secure_connection"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
