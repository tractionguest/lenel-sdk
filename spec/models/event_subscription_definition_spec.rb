...
# Unit tests for LenelSdk::EventSubscriptionDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSubscriptionDefinition' do
  before do
    # run before each test
    @instance = LenelSdk::EventSubscriptionDefinition.new
  end
  ...
  describe 'test an instance of EventSubscriptionDefinition' do
    it 'should create an instance of EventSubscriptionDefinition' do
      expect(@instance).to be_instance_of(LenelSdk::EventSubscriptionDefinition)
    end
  end
