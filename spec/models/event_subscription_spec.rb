...
# Unit tests for SwaggerClient::EventSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventSubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::EventSubscription.new
  end
  ...
  describe 'test an instance of EventSubscription' do
    it 'should create an instance of EventSubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::EventSubscription)
    end
  end
