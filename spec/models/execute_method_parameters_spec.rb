...
# Unit tests for LenelClient::ExecuteMethodParameters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExecuteMethodParameters' do
  before do
    # run before each test
    @instance = LenelClient::ExecuteMethodParameters.new
  end
  ...
  describe 'test an instance of ExecuteMethodParameters' do
    it 'should create an instance of ExecuteMethodParameters' do
      expect(@instance).to be_instance_of(LenelClient::ExecuteMethodParameters)
    end
  end
