...
# Unit tests for SwaggerClient::ExecuteMethodResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExecuteMethodResults' do
  before do
    # run before each test
    @instance = SwaggerClient::ExecuteMethodResults.new
  end
  ...
  describe 'test an instance of ExecuteMethodResults' do
    it 'should create an instance of ExecuteMethodResults' do
      expect(@instance).to be_instance_of(SwaggerClient::ExecuteMethodResults)
    end
  end
  ...
  describe 'test attribute "out_parameter_value_map"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
