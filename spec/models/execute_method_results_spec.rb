...
# Unit tests for LenelClient::ExecuteMethodResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExecuteMethodResults' do
  before do
    # run before each test
    @instance = LenelClient::ExecuteMethodResults.new
  end
  ...
  describe 'test an instance of ExecuteMethodResults' do
    it 'should create an instance of ExecuteMethodResults' do
      expect(@instance).to be_instance_of(LenelClient::ExecuteMethodResults)
    end
  end
