...
# Unit tests for LenelSdk::GetAccessPanelUserInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccessPanelUserInstance' do
  before do
    # run before each test
    @instance = LenelSdk::GetAccessPanelUserInstance.new
  end
  ...
  describe 'test an instance of GetAccessPanelUserInstance' do
    it 'should create an instance of GetAccessPanelUserInstance' do
      expect(@instance).to be_instance_of(LenelSdk::GetAccessPanelUserInstance)
    end
  end
