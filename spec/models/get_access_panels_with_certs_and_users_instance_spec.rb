...
# Unit tests for LenelSdk::GetAccessPanelsWithCertsAndUsersInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccessPanelsWithCertsAndUsersInstance' do
  before do
    # run before each test
    @instance = LenelSdk::GetAccessPanelsWithCertsAndUsersInstance.new
  end
  ...
  describe 'test an instance of GetAccessPanelsWithCertsAndUsersInstance' do
    it 'should create an instance of GetAccessPanelsWithCertsAndUsersInstance' do
      expect(@instance).to be_instance_of(LenelSdk::GetAccessPanelsWithCertsAndUsersInstance)
    end
  end
