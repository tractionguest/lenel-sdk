...
# Unit tests for LenelSdk::GetAccessPanelsWithCertsAndUsersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccessPanelsWithCertsAndUsersResponse' do
  before do
    # run before each test
    @instance = LenelSdk::GetAccessPanelsWithCertsAndUsersResponse.new
  end
  ...
  describe 'test an instance of GetAccessPanelsWithCertsAndUsersResponse' do
    it 'should create an instance of GetAccessPanelsWithCertsAndUsersResponse' do
      expect(@instance).to be_instance_of(LenelSdk::GetAccessPanelsWithCertsAndUsersResponse)
    end
  end
