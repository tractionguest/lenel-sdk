...
# Unit tests for SwaggerClient::GetConsoleCards
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetConsoleCards' do
  before do
    # run before each test
    @instance = SwaggerClient::GetConsoleCards.new
  end
  ...
  describe 'test an instance of GetConsoleCards' do
    it 'should create an instance of GetConsoleCards' do
      expect(@instance).to be_instance_of(SwaggerClient::GetConsoleCards)
    end
  end
