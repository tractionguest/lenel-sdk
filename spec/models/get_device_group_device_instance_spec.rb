...
# Unit tests for LenelSdk::GetDeviceGroupDeviceInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDeviceGroupDeviceInstance' do
  before do
    # run before each test
    @instance = LenelSdk::GetDeviceGroupDeviceInstance.new
  end
  ...
  describe 'test an instance of GetDeviceGroupDeviceInstance' do
    it 'should create an instance of GetDeviceGroupDeviceInstance' do
      expect(@instance).to be_instance_of(LenelSdk::GetDeviceGroupDeviceInstance)
    end
  end
