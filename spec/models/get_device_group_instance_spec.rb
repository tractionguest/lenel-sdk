...
# Unit tests for LenelSdk::GetDeviceGroupInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDeviceGroupInstance' do
  before do
    # run before each test
    @instance = LenelSdk::GetDeviceGroupInstance.new
  end
  ...
  describe 'test an instance of GetDeviceGroupInstance' do
    it 'should create an instance of GetDeviceGroupInstance' do
      expect(@instance).to be_instance_of(LenelSdk::GetDeviceGroupInstance)
    end
  end
