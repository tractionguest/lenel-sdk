...
# Unit tests for SwaggerClient::GetDeviceGroupInstance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDeviceGroupInstance' do
  before do
    # run before each test
    @instance = SwaggerClient::GetDeviceGroupInstance.new
  end
  ...
  describe 'test an instance of GetDeviceGroupInstance' do
    it 'should create an instance of GetDeviceGroupInstance' do
      expect(@instance).to be_instance_of(SwaggerClient::GetDeviceGroupInstance)
    end
  end
