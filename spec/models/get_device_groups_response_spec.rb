...
# Unit tests for SwaggerClient::GetDeviceGroupsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetDeviceGroupsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::GetDeviceGroupsResponse.new
  end
  ...
  describe 'test an instance of GetDeviceGroupsResponse' do
    it 'should create an instance of GetDeviceGroupsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::GetDeviceGroupsResponse)
    end
  end
