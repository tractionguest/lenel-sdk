...
# Unit tests for SwaggerClient::GetLoggedEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetLoggedEvents' do
  before do
    # run before each test
    @instance = SwaggerClient::GetLoggedEvents.new
  end
  ...
  describe 'test an instance of GetLoggedEvents' do
    it 'should create an instance of GetLoggedEvents' do
      expect(@instance).to be_instance_of(SwaggerClient::GetLoggedEvents)
    end
  end
