...
# Unit tests for LenelSdk::GetMapDevicesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMapDevicesResponse' do
  before do
    # run before each test
    @instance = LenelSdk::GetMapDevicesResponse.new
  end
  ...
  describe 'test an instance of GetMapDevicesResponse' do
    it 'should create an instance of GetMapDevicesResponse' do
      expect(@instance).to be_instance_of(LenelSdk::GetMapDevicesResponse)
    end
  end
