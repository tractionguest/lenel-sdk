...
# Unit tests for LenelSdk::GetMapIconGroupsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMapIconGroupsResponse' do
  before do
    # run before each test
    @instance = LenelSdk::GetMapIconGroupsResponse.new
  end
  ...
  describe 'test an instance of GetMapIconGroupsResponse' do
    it 'should create an instance of GetMapIconGroupsResponse' do
      expect(@instance).to be_instance_of(LenelSdk::GetMapIconGroupsResponse)
    end
  end
