...
# Unit tests for SwaggerClient::GetMapIconsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMapIconsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMapIconsResponse.new
  end
  ...
  describe 'test an instance of GetMapIconsResponse' do
    it 'should create an instance of GetMapIconsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMapIconsResponse)
    end
  end
