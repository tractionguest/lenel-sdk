...
# Unit tests for SwaggerClient::GetMapsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMapsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::GetMapsResponse.new
  end
  ...
  describe 'test an instance of GetMapsResponse' do
    it 'should create an instance of GetMapsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::GetMapsResponse)
    end
  end
