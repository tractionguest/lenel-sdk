...
# Unit tests for SwaggerClient::GetUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUserPreferences' do
  before do
    # run before each test
    @instance = SwaggerClient::GetUserPreferences.new
  end
  ...
  describe 'test an instance of GetUserPreferences' do
    it 'should create an instance of GetUserPreferences' do
      expect(@instance).to be_instance_of(SwaggerClient::GetUserPreferences)
    end
  end
  ...
  describe 'test attribute "preference_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
