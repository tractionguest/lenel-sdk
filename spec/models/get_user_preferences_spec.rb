...
# Unit tests for LenelClient::GetUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUserPreferences' do
  before do
    # run before each test
    @instance = LenelClient::GetUserPreferences.new
  end
  ...
  describe 'test an instance of GetUserPreferences' do
    it 'should create an instance of GetUserPreferences' do
      expect(@instance).to be_instance_of(LenelClient::GetUserPreferences)
    end
  end
