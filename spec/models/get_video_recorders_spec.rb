...
# Unit tests for SwaggerClient::GetVideoRecorders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetVideoRecorders' do
  before do
    # run before each test
    @instance = SwaggerClient::GetVideoRecorders.new
  end
  ...
  describe 'test an instance of GetVideoRecorders' do
    it 'should create an instance of GetVideoRecorders' do
      expect(@instance).to be_instance_of(SwaggerClient::GetVideoRecorders)
    end
  end
