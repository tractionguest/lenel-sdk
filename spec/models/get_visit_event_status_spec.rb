...
# Unit tests for SwaggerClient::GetVisitEventStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetVisitEventStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::GetVisitEventStatus.new
  end
  ...
  describe 'test an instance of GetVisitEventStatus' do
    it 'should create an instance of GetVisitEventStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::GetVisitEventStatus)
    end
  end
