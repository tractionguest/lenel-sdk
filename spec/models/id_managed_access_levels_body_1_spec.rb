...
# Unit tests for SwaggerClient::IdManagedAccessLevelsBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdManagedAccessLevelsBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::IdManagedAccessLevelsBody1.new
  end
  ...
  describe 'test an instance of IdManagedAccessLevelsBody1' do
    it 'should create an instance of IdManagedAccessLevelsBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::IdManagedAccessLevelsBody1)
    end
  end
