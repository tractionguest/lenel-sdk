...
# Unit tests for SwaggerClient::IdManagedAccessLevelsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdManagedAccessLevelsBody' do
  before do
    # run before each test
    @instance = SwaggerClient::IdManagedAccessLevelsBody.new
  end
  ...
  describe 'test an instance of IdManagedAccessLevelsBody' do
    it 'should create an instance of IdManagedAccessLevelsBody' do
      expect(@instance).to be_instance_of(SwaggerClient::IdManagedAccessLevelsBody)
    end
  end
