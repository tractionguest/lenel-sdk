...
# Unit tests for LenelSdk::IdManagedAccessLevelsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdManagedAccessLevelsBody' do
  before do
    # run before each test
    @instance = LenelSdk::IdManagedAccessLevelsBody.new
  end
  ...
  describe 'test an instance of IdManagedAccessLevelsBody' do
    it 'should create an instance of IdManagedAccessLevelsBody' do
      expect(@instance).to be_instance_of(LenelSdk::IdManagedAccessLevelsBody)
    end
  end
