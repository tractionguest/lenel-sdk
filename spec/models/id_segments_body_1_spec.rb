...
# Unit tests for SwaggerClient::IdSegmentsBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdSegmentsBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::IdSegmentsBody1.new
  end
  ...
  describe 'test an instance of IdSegmentsBody1' do
    it 'should create an instance of IdSegmentsBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::IdSegmentsBody1)
    end
  end
  describe 'test attribute "segment_list"' do
    it 'should work' do
