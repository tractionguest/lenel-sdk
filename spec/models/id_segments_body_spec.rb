...
# Unit tests for SwaggerClient::IdSegmentsBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdSegmentsBody' do
  before do
    # run before each test
    @instance = SwaggerClient::IdSegmentsBody.new
  end
  ...
  describe 'test an instance of IdSegmentsBody' do
    it 'should create an instance of IdSegmentsBody' do
      expect(@instance).to be_instance_of(SwaggerClient::IdSegmentsBody)
    end
  end
