...
# Unit tests for LenelClient::InParameterValueMap
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InParameterValueMap' do
  before do
    # run before each test
    @instance = LenelClient::InParameterValueMap.new
  end
  ...
  describe 'test an instance of InParameterValueMap' do
    it 'should create an instance of InParameterValueMap' do
      expect(@instance).to be_instance_of(LenelClient::InParameterValueMap)
    end
  end
