...
# Unit tests for SwaggerClient::IncomingEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IncomingEvent' do
  before do
    # run before each test
    @instance = SwaggerClient::IncomingEvent.new
  end
  ...
  describe 'test an instance of IncomingEvent' do
    it 'should create an instance of IncomingEvent' do
      expect(@instance).to be_instance_of(SwaggerClient::IncomingEvent)
    end
  end
