...
# Unit tests for LenelSdk::InlineResponse2004
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2004' do
  before do
    # run before each test
    @instance = LenelSdk::InlineResponse2004.new
  end
  ...
  describe 'test an instance of InlineResponse2004' do
    it 'should create an instance of InlineResponse2004' do
      expect(@instance).to be_instance_of(LenelSdk::InlineResponse2004)
    end
  end
  ...
  describe 'test attribute "og_version"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
