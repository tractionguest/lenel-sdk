...
# Unit tests for SwaggerClient::InstanceDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InstanceDefinition' do
  before do
    # run before each test
    @instance = SwaggerClient::InstanceDefinition.new
  end
  ...
  describe 'test an instance of InstanceDefinition' do
    it 'should create an instance of InstanceDefinition' do
      expect(@instance).to be_instance_of(SwaggerClient::InstanceDefinition)
    end
  end
