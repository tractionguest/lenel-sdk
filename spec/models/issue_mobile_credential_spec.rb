...
# Unit tests for LenelClient::IssueMobileCredential
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueMobileCredential' do
  before do
    # run before each test
    @instance = LenelClient::IssueMobileCredential.new
  end
  ...
  describe 'test an instance of IssueMobileCredential' do
    it 'should create an instance of IssueMobileCredential' do
      expect(@instance).to be_instance_of(LenelClient::IssueMobileCredential)
    end
  end
