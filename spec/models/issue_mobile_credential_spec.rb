...
# Unit tests for SwaggerClient::IssueMobileCredential
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IssueMobileCredential' do
  before do
    # run before each test
    @instance = SwaggerClient::IssueMobileCredential.new
  end
  ...
  describe 'test an instance of IssueMobileCredential' do
    it 'should create an instance of IssueMobileCredential' do
      expect(@instance).to be_instance_of(SwaggerClient::IssueMobileCredential)
    end
  end
  describe 'test attribute "mobile_device_activation_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mobile_device_pin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mobile_device_for_installer"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mobile_issuance_message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
