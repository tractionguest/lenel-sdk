...
# Unit tests for SwaggerClient::Levels1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Levels1' do
  before do
    # run before each test
    @instance = SwaggerClient::Levels1.new
  end
  ...
  describe 'test an instance of Levels1' do
    it 'should create an instance of Levels1' do
      expect(@instance).to be_instance_of(SwaggerClient::Levels1)
    end
  end
