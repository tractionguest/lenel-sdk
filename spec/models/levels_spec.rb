...
# Unit tests for SwaggerClient::Levels
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Levels' do
  before do
    # run before each test
    @instance = SwaggerClient::Levels.new
  end
  ...
  describe 'test an instance of Levels' do
    it 'should create an instance of Levels' do
      expect(@instance).to be_instance_of(SwaggerClient::Levels)
    end
  end
