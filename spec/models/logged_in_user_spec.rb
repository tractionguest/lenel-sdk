...
# Unit tests for SwaggerClient::LoggedInUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoggedInUser' do
  before do
    # run before each test
    @instance = SwaggerClient::LoggedInUser.new
  end
  ...
  describe 'test an instance of LoggedInUser' do
    it 'should create an instance of LoggedInUser' do
      expect(@instance).to be_instance_of(SwaggerClient::LoggedInUser)
    end
  end
  ...
  describe 'test attribute "password_expiration_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ptz_priority"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
