...
# Unit tests for SwaggerClient::ManagedAccessLevelsAccessLevelList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedAccessLevelsAccessLevelList' do
  before do
    # run before each test
    @instance = SwaggerClient::ManagedAccessLevelsAccessLevelList.new
  end
  ...
  describe 'test an instance of ManagedAccessLevelsAccessLevelList' do
    it 'should create an instance of ManagedAccessLevelsAccessLevelList' do
      expect(@instance).to be_instance_of(SwaggerClient::ManagedAccessLevelsAccessLevelList)
    end
  end
