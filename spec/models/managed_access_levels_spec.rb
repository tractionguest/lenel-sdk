...
# Unit tests for SwaggerClient::ManagedAccessLevels
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedAccessLevels' do
  before do
    # run before each test
    @instance = SwaggerClient::ManagedAccessLevels.new
  end
  ...
  describe 'test an instance of ManagedAccessLevels' do
    it 'should create an instance of ManagedAccessLevels' do
      expect(@instance).to be_instance_of(SwaggerClient::ManagedAccessLevels)
    end
  end
  ...
  describe 'test attribute "access_level_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
