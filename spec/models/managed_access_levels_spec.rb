...
# Unit tests for LenelClient::ManagedAccessLevels
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedAccessLevels' do
  before do
    # run before each test
    @instance = LenelClient::ManagedAccessLevels.new
  end
  ...
  describe 'test an instance of ManagedAccessLevels' do
    it 'should create an instance of ManagedAccessLevels' do
      expect(@instance).to be_instance_of(LenelClient::ManagedAccessLevels)
    end
  end
