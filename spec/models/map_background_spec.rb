...
# Unit tests for SwaggerClient::MapBackground
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MapBackground' do
  before do
    # run before each test
    @instance = SwaggerClient::MapBackground.new
  end
  ...
  describe 'test an instance of MapBackground' do
    it 'should create an instance of MapBackground' do
      expect(@instance).to be_instance_of(SwaggerClient::MapBackground)
    end
  end
  describe 'test attribute "map_background_data"' do
    it 'should work' do
