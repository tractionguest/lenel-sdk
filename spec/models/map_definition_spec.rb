...
# Unit tests for SwaggerClient::MapDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MapDefinition' do
  before do
    # run before each test
    @instance = SwaggerClient::MapDefinition.new
  end
  ...
  describe 'test an instance of MapDefinition' do
    it 'should create an instance of MapDefinition' do
      expect(@instance).to be_instance_of(SwaggerClient::MapDefinition)
    end
  end
  describe 'test attribute "map_id"' do
    it 'should work' do
