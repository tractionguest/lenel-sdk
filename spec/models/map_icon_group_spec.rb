...
# Unit tests for SwaggerClient::MapIconGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MapIconGroup' do
  before do
    # run before each test
    @instance = SwaggerClient::MapIconGroup.new
  end
  ...
  describe 'test an instance of MapIconGroup' do
    it 'should create an instance of MapIconGroup' do
      expect(@instance).to be_instance_of(SwaggerClient::MapIconGroup)
    end
  end
  ...
  describe 'test attribute "map_item_group_members"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
