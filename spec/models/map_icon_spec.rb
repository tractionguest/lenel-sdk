...
# Unit tests for SwaggerClient::MapIcon
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MapIcon' do
  before do
    # run before each test
    @instance = SwaggerClient::MapIcon.new
  end
  ...
  describe 'test an instance of MapIcon' do
    it 'should create an instance of MapIcon' do
      expect(@instance).to be_instance_of(SwaggerClient::MapIcon)
    end
  end
