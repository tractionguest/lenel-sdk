...
# Unit tests for SwaggerClient::MapItemGroupMember
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MapItemGroupMember' do
  before do
    # run before each test
    @instance = SwaggerClient::MapItemGroupMember.new
  end
  ...
  describe 'test an instance of MapItemGroupMember' do
    it 'should create an instance of MapItemGroupMember' do
      expect(@instance).to be_instance_of(SwaggerClient::MapItemGroupMember)
    end
  end
