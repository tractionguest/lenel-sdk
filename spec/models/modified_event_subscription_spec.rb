...
# Unit tests for LenelSdk::ModifiedEventSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifiedEventSubscription' do
  before do
    # run before each test
    @instance = LenelSdk::ModifiedEventSubscription.new
  end
  ...
  describe 'test an instance of ModifiedEventSubscription' do
    it 'should create an instance of ModifiedEventSubscription' do
      expect(@instance).to be_instance_of(LenelSdk::ModifiedEventSubscription)
    end
  end
