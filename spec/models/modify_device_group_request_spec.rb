...
# Unit tests for SwaggerClient::ModifyDeviceGroupRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyDeviceGroupRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::ModifyDeviceGroupRequest.new
  end
  ...
  describe 'test an instance of ModifyDeviceGroupRequest' do
    it 'should create an instance of ModifyDeviceGroupRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::ModifyDeviceGroupRequest)
    end
  end
