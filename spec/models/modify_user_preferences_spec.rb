...
# Unit tests for LenelSDK::ModifyUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyUserPreferences' do
  before do
    # run before each test
    @instance = LenelSDK::ModifyUserPreferences.new
  end
  ...
  describe 'test an instance of ModifyUserPreferences' do
    it 'should create an instance of ModifyUserPreferences' do
      expect(@instance).to be_instance_of(LenelSDK::ModifyUserPreferences)
    end
  end
