...
# Unit tests for SwaggerClient::ModifyUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyUserPreferences' do
  before do
    # run before each test
    @instance = SwaggerClient::ModifyUserPreferences.new
  end
  ...
  describe 'test an instance of ModifyUserPreferences' do
    it 'should create an instance of ModifyUserPreferences' do
      expect(@instance).to be_instance_of(SwaggerClient::ModifyUserPreferences)
    end
  end
  ...
  describe 'test attribute "preference_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "preference_settings"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
