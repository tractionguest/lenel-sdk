...
# Unit tests for LenelClient::ModifyUserPreferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ModifyUserPreferences' do
  before do
    # run before each test
    @instance = LenelClient::ModifyUserPreferences.new
  end
  ...
  describe 'test an instance of ModifyUserPreferences' do
    it 'should create an instance of ModifyUserPreferences' do
      expect(@instance).to be_instance_of(LenelClient::ModifyUserPreferences)
    end
  end
