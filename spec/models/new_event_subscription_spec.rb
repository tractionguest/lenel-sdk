...
# Unit tests for LenelClient::NewEventSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewEventSubscription' do
  before do
    # run before each test
    @instance = LenelClient::NewEventSubscription.new
  end
  ...
  describe 'test an instance of NewEventSubscription' do
    it 'should create an instance of NewEventSubscription' do
      expect(@instance).to be_instance_of(LenelClient::NewEventSubscription)
    end
  end
