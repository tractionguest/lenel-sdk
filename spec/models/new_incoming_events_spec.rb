...
# Unit tests for SwaggerClient::NewIncomingEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewIncomingEvents' do
  before do
    # run before each test
    @instance = SwaggerClient::NewIncomingEvents.new
  end
  ...
  describe 'test an instance of NewIncomingEvents' do
    it 'should create an instance of NewIncomingEvents' do
      expect(@instance).to be_instance_of(SwaggerClient::NewIncomingEvents)
    end
  end
  describe 'test attribute "incoming_event_list"' do
    it 'should work' do
