...
# Unit tests for SwaggerClient::NewQueuedTask
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewQueuedTask' do
  before do
    # run before each test
    @instance = SwaggerClient::NewQueuedTask.new
  end
  ...
  describe 'test an instance of NewQueuedTask' do
    it 'should create an instance of NewQueuedTask' do
      expect(@instance).to be_instance_of(SwaggerClient::NewQueuedTask)
    end
  end
