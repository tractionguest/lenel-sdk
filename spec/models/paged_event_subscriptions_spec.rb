...
# Unit tests for SwaggerClient::PagedEventSubscriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagedEventSubscriptions' do
  before do
    # run before each test
    @instance = SwaggerClient::PagedEventSubscriptions.new
  end
  ...
  describe 'test an instance of PagedEventSubscriptions' do
    it 'should create an instance of PagedEventSubscriptions' do
      expect(@instance).to be_instance_of(SwaggerClient::PagedEventSubscriptions)
    end
  end
