...
# Unit tests for SwaggerClient::PagedInstances
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PagedInstances' do
  before do
    # run before each test
    @instance = SwaggerClient::PagedInstances.new
  end
  ...
  describe 'test an instance of PagedInstances' do
    it 'should create an instance of PagedInstances' do
      expect(@instance).to be_instance_of(SwaggerClient::PagedInstances)
    end
  end
