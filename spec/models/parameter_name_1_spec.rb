...
# Unit tests for SwaggerClient::ParameterName1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParameterName1' do
  before do
    # run before each test
    @instance = SwaggerClient::ParameterName1.new
  end
  ...
  describe 'test an instance of ParameterName1' do
    it 'should create an instance of ParameterName1' do
      expect(@instance).to be_instance_of(SwaggerClient::ParameterName1)
    end
  end
