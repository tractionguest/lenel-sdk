...
# Unit tests for SwaggerClient::ParameterName2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParameterName2' do
  before do
    # run before each test
    @instance = SwaggerClient::ParameterName2.new
  end
  ...
  describe 'test an instance of ParameterName2' do
    it 'should create an instance of ParameterName2' do
      expect(@instance).to be_instance_of(SwaggerClient::ParameterName2)
    end
  end
