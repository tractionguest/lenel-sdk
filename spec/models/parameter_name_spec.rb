...
# Unit tests for SwaggerClient::ParameterName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ParameterName' do
  before do
    # run before each test
    @instance = SwaggerClient::ParameterName.new
  end
  ...
  describe 'test an instance of ParameterName' do
    it 'should create an instance of ParameterName' do
      expect(@instance).to be_instance_of(SwaggerClient::ParameterName)
    end
  end
