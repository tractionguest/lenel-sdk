...
# Unit tests for SwaggerClient::PartnerValues1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartnerValues1' do
  before do
    # run before each test
    @instance = SwaggerClient::PartnerValues1.new
  end
  ...
  describe 'test an instance of PartnerValues1' do
    it 'should create an instance of PartnerValues1' do
      expect(@instance).to be_instance_of(SwaggerClient::PartnerValues1)
    end
  end
