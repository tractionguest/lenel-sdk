...
# Unit tests for SwaggerClient::PartnerValuesBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartnerValuesBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::PartnerValuesBody1.new
  end
  ...
  describe 'test an instance of PartnerValuesBody1' do
    it 'should create an instance of PartnerValuesBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::PartnerValuesBody1)
    end
  end
  describe 'test attribute "partner_value_1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partner_value_2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partner_value_3"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partner_value_4"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partner_value_5"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
