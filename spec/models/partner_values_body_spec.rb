...
# Unit tests for SwaggerClient::PartnerValuesBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartnerValuesBody' do
  before do
    # run before each test
    @instance = SwaggerClient::PartnerValuesBody.new
  end
  ...
  describe 'test an instance of PartnerValuesBody' do
    it 'should create an instance of PartnerValuesBody' do
      expect(@instance).to be_instance_of(SwaggerClient::PartnerValuesBody)
    end
  end
