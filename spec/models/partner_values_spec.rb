...
# Unit tests for SwaggerClient::PartnerValues
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartnerValues' do
  before do
    # run before each test
    @instance = SwaggerClient::PartnerValues.new
  end
  ...
  describe 'test an instance of PartnerValues' do
    it 'should create an instance of PartnerValues' do
      expect(@instance).to be_instance_of(SwaggerClient::PartnerValues)
    end
  end
