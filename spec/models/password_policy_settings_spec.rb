...
# Unit tests for LenelSdk::PasswordPolicySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PasswordPolicySettings' do
  before do
    # run before each test
    @instance = LenelSdk::PasswordPolicySettings.new
  end
  ...
  describe 'test an instance of PasswordPolicySettings' do
    it 'should create an instance of PasswordPolicySettings' do
      expect(@instance).to be_instance_of(LenelSdk::PasswordPolicySettings)
    end
  end
