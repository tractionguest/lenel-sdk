...
# Unit tests for SwaggerClient::PrintRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PrintRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::PrintRequest.new
  end
  ...
  describe 'test an instance of PrintRequest' do
    it 'should create an instance of PrintRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::PrintRequest)
    end
  end
