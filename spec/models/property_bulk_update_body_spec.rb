...
# Unit tests for LenelSdk::PropertyBulkUpdateBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PropertyBulkUpdateBody' do
  before do
    # run before each test
    @instance = LenelSdk::PropertyBulkUpdateBody.new
  end
  ...
  describe 'test an instance of PropertyBulkUpdateBody' do
    it 'should create an instance of PropertyBulkUpdateBody' do
      expect(@instance).to be_instance_of(LenelSdk::PropertyBulkUpdateBody)
    end
  end
