...
# Unit tests for SwaggerClient::QueuedTask
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueuedTask' do
  before do
    # run before each test
    @instance = SwaggerClient::QueuedTask.new
  end
  ...
  describe 'test an instance of QueuedTask' do
    it 'should create an instance of QueuedTask' do
      expect(@instance).to be_instance_of(SwaggerClient::QueuedTask)
    end
  end
