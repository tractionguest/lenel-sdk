...
# Unit tests for LenelClient::QueuedTasksItemList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueuedTasksItemList' do
  before do
    # run before each test
    @instance = LenelClient::QueuedTasksItemList.new
  end
  ...
  describe 'test an instance of QueuedTasksItemList' do
    it 'should create an instance of QueuedTasksItemList' do
      expect(@instance).to be_instance_of(LenelClient::QueuedTasksItemList)
    end
  end
