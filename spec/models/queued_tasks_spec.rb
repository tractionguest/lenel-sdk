...
# Unit tests for SwaggerClient::QueuedTasks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueuedTasks' do
  before do
    # run before each test
    @instance = SwaggerClient::QueuedTasks.new
  end
  ...
  describe 'test an instance of QueuedTasks' do
    it 'should create an instance of QueuedTasks' do
      expect(@instance).to be_instance_of(SwaggerClient::QueuedTasks)
    end
  end
