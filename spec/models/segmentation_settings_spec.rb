...
# Unit tests for LenelClient::SegmentationSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SegmentationSettings' do
  before do
    # run before each test
    @instance = LenelClient::SegmentationSettings.new
  end
  ...
  describe 'test an instance of SegmentationSettings' do
    it 'should create an instance of SegmentationSettings' do
      expect(@instance).to be_instance_of(LenelClient::SegmentationSettings)
    end
  end
