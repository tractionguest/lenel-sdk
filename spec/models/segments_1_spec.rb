...
# Unit tests for SwaggerClient::Segments1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Segments1' do
  before do
    # run before each test
    @instance = SwaggerClient::Segments1.new
  end
  ...
  describe 'test an instance of Segments1' do
    it 'should create an instance of Segments1' do
      expect(@instance).to be_instance_of(SwaggerClient::Segments1)
    end
  end
