...
# Unit tests for SwaggerClient::SegmentsSegmentList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SegmentsSegmentList' do
  before do
    # run before each test
    @instance = SwaggerClient::SegmentsSegmentList.new
  end
  ...
  describe 'test an instance of SegmentsSegmentList' do
    it 'should create an instance of SegmentsSegmentList' do
      expect(@instance).to be_instance_of(SwaggerClient::SegmentsSegmentList)
    end
  end
