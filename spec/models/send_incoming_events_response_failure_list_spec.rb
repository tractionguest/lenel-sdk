...
# Unit tests for SwaggerClient::SendIncomingEventsResponseFailureList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendIncomingEventsResponseFailureList' do
  before do
    # run before each test
    @instance = SwaggerClient::SendIncomingEventsResponseFailureList.new
  end
  ...
  describe 'test an instance of SendIncomingEventsResponseFailureList' do
    it 'should create an instance of SendIncomingEventsResponseFailureList' do
      expect(@instance).to be_instance_of(SwaggerClient::SendIncomingEventsResponseFailureList)
    end
  end
