...
# Unit tests for LenelSdk::SendIncomingEventsResponseFailureList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendIncomingEventsResponseFailureList' do
  before do
    # run before each test
    @instance = LenelSdk::SendIncomingEventsResponseFailureList.new
  end
  ...
  describe 'test an instance of SendIncomingEventsResponseFailureList' do
    it 'should create an instance of SendIncomingEventsResponseFailureList' do
      expect(@instance).to be_instance_of(LenelSdk::SendIncomingEventsResponseFailureList)
    end
  end
