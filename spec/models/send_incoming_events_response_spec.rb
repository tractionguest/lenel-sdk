...
# Unit tests for SwaggerClient::SendIncomingEventsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendIncomingEventsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::SendIncomingEventsResponse.new
  end
  ...
  describe 'test an instance of SendIncomingEventsResponse' do
    it 'should create an instance of SendIncomingEventsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::SendIncomingEventsResponse)
    end
  end
