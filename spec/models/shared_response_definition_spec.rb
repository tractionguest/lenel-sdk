...
# Unit tests for LenelSDK::SharedResponseDefinition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedResponseDefinition' do
  before do
    # run before each test
    @instance = LenelSDK::SharedResponseDefinition.new
  end
  ...
  describe 'test an instance of SharedResponseDefinition' do
    it 'should create an instance of SharedResponseDefinition' do
      expect(@instance).to be_instance_of(LenelSDK::SharedResponseDefinition)
    end
  end
