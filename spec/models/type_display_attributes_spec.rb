...
# Unit tests for LenelSDK::TypeDisplayAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TypeDisplayAttributes' do
  before do
    # run before each test
    @instance = LenelSDK::TypeDisplayAttributes.new
  end
  ...
  describe 'test an instance of TypeDisplayAttributes' do
    it 'should create an instance of TypeDisplayAttributes' do
      expect(@instance).to be_instance_of(LenelSDK::TypeDisplayAttributes)
    end
  end
