...
# Unit tests for SwaggerClient::TypeDisplayGroups
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TypeDisplayGroups' do
  before do
    # run before each test
    @instance = SwaggerClient::TypeDisplayGroups.new
  end
  ...
  describe 'test an instance of TypeDisplayGroups' do
    it 'should create an instance of TypeDisplayGroups' do
      expect(@instance).to be_instance_of(SwaggerClient::TypeDisplayGroups)
    end
  end
