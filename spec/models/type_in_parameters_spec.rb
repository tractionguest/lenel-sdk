...
# Unit tests for SwaggerClient::TypeInParameters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TypeInParameters' do
  before do
    # run before each test
    @instance = SwaggerClient::TypeInParameters.new
  end
  ...
  describe 'test an instance of TypeInParameters' do
    it 'should create an instance of TypeInParameters' do
      expect(@instance).to be_instance_of(SwaggerClient::TypeInParameters)
    end
  end
