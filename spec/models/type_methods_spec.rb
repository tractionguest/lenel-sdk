...
# Unit tests for SwaggerClient::TypeMethods
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TypeMethods' do
  before do
    # run before each test
    @instance = SwaggerClient::TypeMethods.new
  end
  ...
  describe 'test an instance of TypeMethods' do
    it 'should create an instance of TypeMethods' do
      expect(@instance).to be_instance_of(SwaggerClient::TypeMethods)
    end
  end
  ...
  describe 'test attribute "in_parameters"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "out_parameters"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
