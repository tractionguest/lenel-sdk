...
# Unit tests for SwaggerClient::TypeProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TypeProperties' do
  before do
    # run before each test
    @instance = SwaggerClient::TypeProperties.new
  end
  ...
  describe 'test an instance of TypeProperties' do
    it 'should create an instance of TypeProperties' do
      expect(@instance).to be_instance_of(SwaggerClient::TypeProperties)
    end
  end
  ...
  describe 'test attribute "display_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "is_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
