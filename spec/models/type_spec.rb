...
# Unit tests for LenelClient::Type
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Type' do
  before do
    # run before each test
    @instance = LenelClient::Type.new
  end
  ...
  describe 'test an instance of Type' do
    it 'should create an instance of Type' do
      expect(@instance).to be_instance_of(LenelClient::Type)
    end
  end
  ...
  describe 'test attribute "display_groups"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
