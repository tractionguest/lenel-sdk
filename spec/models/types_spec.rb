...
# Unit tests for SwaggerClient::Types
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Types' do
  before do
    # run before each test
    @instance = SwaggerClient::Types.new
  end
  ...
  describe 'test an instance of Types' do
    it 'should create an instance of Types' do
      expect(@instance).to be_instance_of(SwaggerClient::Types)
    end
  end
