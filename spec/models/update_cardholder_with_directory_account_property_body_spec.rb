...
# Unit tests for LenelSdk::UpdateCardholderWithDirectoryAccountPropertyBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCardholderWithDirectoryAccountPropertyBody' do
  before do
    # run before each test
    @instance = LenelSdk::UpdateCardholderWithDirectoryAccountPropertyBody.new
  end
  ...
  describe 'test an instance of UpdateCardholderWithDirectoryAccountPropertyBody' do
    it 'should create an instance of UpdateCardholderWithDirectoryAccountPropertyBody' do
      expect(@instance).to be_instance_of(LenelSdk::UpdateCardholderWithDirectoryAccountPropertyBody)
    end
  end
