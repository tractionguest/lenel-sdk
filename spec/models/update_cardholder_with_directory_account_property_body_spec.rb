...
# Unit tests for SwaggerClient::UpdateCardholderWithDirectoryAccountPropertyBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCardholderWithDirectoryAccountPropertyBody' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateCardholderWithDirectoryAccountPropertyBody.new
  end
  ...
  describe 'test an instance of UpdateCardholderWithDirectoryAccountPropertyBody' do
    it 'should create an instance of UpdateCardholderWithDirectoryAccountPropertyBody' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateCardholderWithDirectoryAccountPropertyBody)
    end
  end
  describe 'test attribute "directory_account_property"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "cardholder_property"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "can_overwrite"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
