...
# Unit tests for SwaggerClient::UpdateCardholderWithDirectoryAccountProperty
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCardholderWithDirectoryAccountProperty' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateCardholderWithDirectoryAccountProperty.new
  end
  ...
  describe 'test an instance of UpdateCardholderWithDirectoryAccountProperty' do
    it 'should create an instance of UpdateCardholderWithDirectoryAccountProperty' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateCardholderWithDirectoryAccountProperty)
    end
  end
  ...
  describe 'test attribute "property_written"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
