...
# Unit tests for LenelSdk::UpdateCardholderWithDirectoryAccountProperty
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateCardholderWithDirectoryAccountProperty' do
  before do
    # run before each test
    @instance = LenelSdk::UpdateCardholderWithDirectoryAccountProperty.new
  end
  ...
  describe 'test an instance of UpdateCardholderWithDirectoryAccountProperty' do
    it 'should create an instance of UpdateCardholderWithDirectoryAccountProperty' do
      expect(@instance).to be_instance_of(LenelSdk::UpdateCardholderWithDirectoryAccountProperty)
    end
  end
