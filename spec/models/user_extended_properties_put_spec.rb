...
# Unit tests for SwaggerClient::UserExtendedPropertiesPut
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserExtendedPropertiesPut' do
  before do
    # run before each test
    @instance = SwaggerClient::UserExtendedPropertiesPut.new
  end
  ...
  describe 'test an instance of UserExtendedPropertiesPut' do
    it 'should create an instance of UserExtendedPropertiesPut' do
      expect(@instance).to be_instance_of(SwaggerClient::UserExtendedPropertiesPut)
    end
  end
  ...
  describe 'test attribute "unlock_account"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
