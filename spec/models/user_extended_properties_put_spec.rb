...
# Unit tests for LenelSdk::UserExtendedPropertiesPut
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserExtendedPropertiesPut' do
  before do
    # run before each test
    @instance = LenelSdk::UserExtendedPropertiesPut.new
  end
  ...
  describe 'test an instance of UserExtendedPropertiesPut' do
    it 'should create an instance of UserExtendedPropertiesPut' do
      expect(@instance).to be_instance_of(LenelSdk::UserExtendedPropertiesPut)
    end
  end
