...
# Unit tests for LenelClient::UserExtendedProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserExtendedProperties' do
  before do
    # run before each test
    @instance = LenelClient::UserExtendedProperties.new
  end
  ...
  describe 'test an instance of UserExtendedProperties' do
    it 'should create an instance of UserExtendedProperties' do
      expect(@instance).to be_instance_of(LenelClient::UserExtendedProperties)
    end
  end
