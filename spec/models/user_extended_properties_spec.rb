...
# Unit tests for SwaggerClient::UserExtendedProperties
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserExtendedProperties' do
  before do
    # run before each test
    @instance = SwaggerClient::UserExtendedProperties.new
  end
  ...
  describe 'test an instance of UserExtendedProperties' do
    it 'should create an instance of UserExtendedProperties' do
      expect(@instance).to be_instance_of(SwaggerClient::UserExtendedProperties)
    end
  end
  ...
  describe 'test attribute "has_aam_view_only_access"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "monitoring_zone_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_user_account_locked"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "last_successful_login_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
