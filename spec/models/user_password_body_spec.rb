...
# Unit tests for SwaggerClient::UserPasswordBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPasswordBody' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPasswordBody.new
  end
  ...
  describe 'test an instance of UserPasswordBody' do
    it 'should create an instance of UserPasswordBody' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPasswordBody)
    end
  end
