...
# Unit tests for SwaggerClient::UserPreference
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPreference' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPreference.new
  end
  ...
  describe 'test an instance of UserPreference' do
    it 'should create an instance of UserPreference' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPreference)
    end
  end
