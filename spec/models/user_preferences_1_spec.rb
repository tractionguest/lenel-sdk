...
# Unit tests for SwaggerClient::UserPreferences1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPreferences1' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPreferences1.new
  end
  ...
  describe 'test an instance of UserPreferences1' do
    it 'should create an instance of UserPreferences1' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPreferences1)
    end
  end
