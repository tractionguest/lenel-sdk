...
# Unit tests for SwaggerClient::UserPreferencesBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPreferencesBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPreferencesBody1.new
  end
  ...
  describe 'test an instance of UserPreferencesBody1' do
    it 'should create an instance of UserPreferencesBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPreferencesBody1)
    end
  end
