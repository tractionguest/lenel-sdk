...
# Unit tests for SwaggerClient::UserPreferencesBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserPreferencesBody' do
  before do
    # run before each test
    @instance = SwaggerClient::UserPreferencesBody.new
  end
  ...
  describe 'test an instance of UserPreferencesBody' do
    it 'should create an instance of UserPreferencesBody' do
      expect(@instance).to be_instance_of(SwaggerClient::UserPreferencesBody)
    end
  end
