...
# Unit tests for SwaggerClient::VideoOptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoOptions' do
  before do
    # run before each test
    @instance = SwaggerClient::VideoOptions.new
  end
  ...
  describe 'test an instance of VideoOptions' do
    it 'should create an instance of VideoOptions' do
      expect(@instance).to be_instance_of(SwaggerClient::VideoOptions)
    end
  end
  describe 'test attribute "instant_rewind_time_in_seconds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "time_limited_playback_restriction_in_minutes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
