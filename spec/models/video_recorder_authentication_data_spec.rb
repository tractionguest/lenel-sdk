...
# Unit tests for SwaggerClient::VideoRecorderAuthenticationData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoRecorderAuthenticationData' do
  before do
    # run before each test
    @instance = SwaggerClient::VideoRecorderAuthenticationData.new
  end
  ...
  describe 'test an instance of VideoRecorderAuthenticationData' do
    it 'should create an instance of VideoRecorderAuthenticationData' do
      expect(@instance).to be_instance_of(SwaggerClient::VideoRecorderAuthenticationData)
    end
  end
  ...
  describe 'test attribute "authentication_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
