...
# Unit tests for LenelSdk::VideoRecorderAuthenticationData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoRecorderAuthenticationData' do
  before do
    # run before each test
    @instance = LenelSdk::VideoRecorderAuthenticationData.new
  end
  ...
  describe 'test an instance of VideoRecorderAuthenticationData' do
    it 'should create an instance of VideoRecorderAuthenticationData' do
      expect(@instance).to be_instance_of(LenelSdk::VideoRecorderAuthenticationData)
    end
  end
