...
# Unit tests for LenelClient::VideoRecorderAuthenticationData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoRecorderAuthenticationData' do
  before do
    # run before each test
    @instance = LenelClient::VideoRecorderAuthenticationData.new
  end
  ...
  describe 'test an instance of VideoRecorderAuthenticationData' do
    it 'should create an instance of VideoRecorderAuthenticationData' do
      expect(@instance).to be_instance_of(LenelClient::VideoRecorderAuthenticationData)
    end
  end
