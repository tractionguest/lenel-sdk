...
# Unit tests for SwaggerClient::VideoRecorderCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoRecorderCredentials' do
  before do
    # run before each test
    @instance = SwaggerClient::VideoRecorderCredentials.new
  end
  ...
  describe 'test an instance of VideoRecorderCredentials' do
    it 'should create an instance of VideoRecorderCredentials' do
      expect(@instance).to be_instance_of(SwaggerClient::VideoRecorderCredentials)
    end
  end
  describe 'test attribute "video_recorder_hashed_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "video_recorder_user_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
