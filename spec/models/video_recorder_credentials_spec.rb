...
# Unit tests for LenelSdk::VideoRecorderCredentials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VideoRecorderCredentials' do
  before do
    # run before each test
    @instance = LenelSdk::VideoRecorderCredentials.new
  end
  ...
  describe 'test an instance of VideoRecorderCredentials' do
    it 'should create an instance of VideoRecorderCredentials' do
      expect(@instance).to be_instance_of(LenelSdk::VideoRecorderCredentials)
    end
  end
