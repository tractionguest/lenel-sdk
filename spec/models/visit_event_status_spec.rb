...
# Unit tests for SwaggerClient::VisitEventStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisitEventStatus' do
  before do
    # run before each test
    @instance = SwaggerClient::VisitEventStatus.new
  end
  ...
  describe 'test an instance of VisitEventStatus' do
    it 'should create an instance of VisitEventStatus' do
      expect(@instance).to be_instance_of(SwaggerClient::VisitEventStatus)
    end
  end
  ...
  describe 'test attribute "visits_scheduled"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "visits_late"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "visits_active"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "visits_overstayed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "visits_finisched"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
