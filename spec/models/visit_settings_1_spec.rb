...
# Unit tests for SwaggerClient::VisitSettings1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisitSettings1' do
  before do
    # run before each test
    @instance = SwaggerClient::VisitSettings1.new
  end
  ...
  describe 'test an instance of VisitSettings1' do
    it 'should create an instance of VisitSettings1' do
      expect(@instance).to be_instance_of(SwaggerClient::VisitSettings1)
    end
  end
