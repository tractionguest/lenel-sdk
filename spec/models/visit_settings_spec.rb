...
# Unit tests for SwaggerClient::VisitSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisitSettings' do
  before do
    # run before each test
    @instance = SwaggerClient::VisitSettings.new
  end
  ...
  describe 'test an instance of VisitSettings' do
    it 'should create an instance of VisitSettings' do
      expect(@instance).to be_instance_of(SwaggerClient::VisitSettings)
    end
  end
